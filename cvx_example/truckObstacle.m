...
o.width=3;                  %[m] obstacle width
o.length=20;                %[m] obstacle length
o.latsafetymargin=0.5;      %[m] lateral safety margin to surrounding object
o.longsafetymargin=50;       %[m] longitudinal safety margin to surrounding object
