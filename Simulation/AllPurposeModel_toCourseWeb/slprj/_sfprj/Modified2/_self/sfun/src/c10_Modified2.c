...
static void initialize_c10_Modified2(SFc10_Modified2InstanceStruct
  *chartInstance);
static void initialize_params_c10_Modified2(SFc10_Modified2InstanceStruct
  *chartInstance);
static void enable_c10_Modified2(SFc10_Modified2InstanceStruct *chartInstance);
static void disable_c10_Modified2(SFc10_Modified2InstanceStruct *chartInstance);
static void c10_update_debugger_state_c10_Modified2
  (SFc10_Modified2InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c10_Modified2(SFc10_Modified2InstanceStruct *
  chartInstance);
static void set_sim_state_c10_Modified2(SFc10_Modified2InstanceStruct
  *chartInstance, const mxArray *c10_st);
static void finalize_c10_Modified2(SFc10_Modified2InstanceStruct *chartInstance);
static void sf_gateway_c10_Modified2(SFc10_Modified2InstanceStruct
  *chartInstance);
static void mdl_start_c10_Modified2(SFc10_Modified2InstanceStruct *chartInstance);
static void c10_chartstep_c10_Modified2(SFc10_Modified2InstanceStruct
  *chartInstance);
static void initSimStructsc10_Modified2(SFc10_Modified2InstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c10_machineNumber, uint32_T
  c10_chartNumber, uint32_T c10_instanceNumber);
static const mxArray *c10_sf_marshallOut(void *chartInstanceVoid, void
  *c10_inData);
static c10_whl_vec4 c10_emlrt_marshallIn(SFc10_Modified2InstanceStruct
  *chartInstance, const mxArray *c10_b_derF_s4, const char_T *c10_identifier);
static c10_whl_vec4 c10_b_emlrt_marshallIn(SFc10_Modified2InstanceStruct
  *chartInstance, const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId);
static real_T c10_c_emlrt_marshallIn(SFc10_Modified2InstanceStruct
  *chartInstance, const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId);
static void c10_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c10_mxArrayInData, const char_T *c10_varName, void *c10_outData);
static const mxArray *c10_b_sf_marshallOut(void *chartInstanceVoid, void
  *c10_inData);
static void c10_d_emlrt_marshallIn(SFc10_Modified2InstanceStruct *chartInstance,
  const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId,
  c10_struct_iBlsPBO3AGnt69vDoTx5zD *c10_y);
static void c10_e_emlrt_marshallIn(SFc10_Modified2InstanceStruct *chartInstance,
  const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId,
  c10_struct_Nst2vGTExxHsg85EUOj9EH *c10_y);
static c10_struct_HhckT6rntEraqECYVIDvCC c10_f_emlrt_marshallIn
  (SFc10_Modified2InstanceStruct *chartInstance, const mxArray *c10_u, const
   emlrtMsgIdentifier *c10_parentId);
static void c10_g_emlrt_marshallIn(SFc10_Modified2InstanceStruct *chartInstance,
  const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId,
  c10_struct_ZCmOWPuqBDw16FSOVVD00 *c10_y);
static void c10_h_emlrt_marshallIn(SFc10_Modified2InstanceStruct *chartInstance,
  const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId, real_T c10_y[4]);
static void c10_i_emlrt_marshallIn(SFc10_Modified2InstanceStruct *chartInstance,
  const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId,
  c10_struct_ZKAzdrl7umDGJoC14aoVKC *c10_y);
static void c10_j_emlrt_marshallIn(SFc10_Modified2InstanceStruct *chartInstance,
...
static real_T c10_eml_xdotu(SFc10_Modified2InstanceStruct *chartInstance, real_T
  c10_x[2], real_T c10_y[2]);
static const mxArray *c10_d_sf_marshallOut(void *chartInstanceVoid, void
  *c10_inData);
static int32_T c10_m_emlrt_marshallIn(SFc10_Modified2InstanceStruct
  *chartInstance, const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId);
...
static uint8_T c10_n_emlrt_marshallIn(SFc10_Modified2InstanceStruct
  *chartInstance, const mxArray *c10_b_is_active_c10_Modified2, const char_T
  *c10_identifier);
static uint8_T c10_o_emlrt_marshallIn(SFc10_Modified2InstanceStruct
  *chartInstance, const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId);
static void init_dsm_address_info(SFc10_Modified2InstanceStruct *chartInstance);
static void init_simulink_io_address(SFc10_Modified2InstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c10_is_active_c10_Modified2 = 0U;
}
  ...
  chartInstance)
{
  ...
  c10_hoistedGlobal = chartInstance->c10_is_active_c10_Modified2;
  ...
  *chartInstance, const mxArray *c10_st)
{
  ...
  *(real_T *)&((char_T *)chartInstance->c10_derF_s4)[24] = c10_r1.rr;
  chartInstance->c10_is_active_c10_Modified2 = c10_n_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c10_u, 1)),
     "is_active_c10_Modified2");
  sf_mex_destroy(&c10_u);
  c10_update_debugger_state_c10_Modified2(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c10_sfEvent = CALL_EVENT;
  c10_chartstep_c10_Modified2(chartInstance);
  ...
  *c10_inData)
{
  ...
  const mxArray *c10_e_y = NULL;
  SFc10_Modified2InstanceStruct *chartInstance;
  chartInstance = (SFc10_Modified2InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c10_Modified2_get_eml_resolved_functions_info(void)
{
  ...
  *c10_identifier)
{
  ...
  c10_y = c10_o_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c10_b_is_active_c10_Modified2), &c10_thisId);
  sf_mex_destroy(&c10_b_is_active_c10_Modified2);
  return c10_y;
}
...
void sf_c10_Modified2_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c10_Modified2_get_post_codegen_info(void);
mxArray *sf_c10_Modified2_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c10_Modified2_get_post_codegen_info();
...
mxArray *sf_c10_Modified2_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c10_Modified2_jit_fallback_info(void)
{
...
mxArray *sf_c10_Modified2_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c10_Modified2(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[7],T\"derF_s4\",},{M[8],M[0],T\"is_active_c10_Modified2\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c10_Modified2_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc10_Modified2InstanceStruct *) chartInfo->chartInstance;
...
static void sf_opaque_initialize_c10_Modified2(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc10_Modified2InstanceStruct*) chartInstanceVar
    )->S,0);
  initialize_params_c10_Modified2((SFc10_Modified2InstanceStruct*)
    chartInstanceVar);
  initialize_c10_Modified2((SFc10_Modified2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c10_Modified2(void *chartInstanceVar)
{
  enable_c10_Modified2((SFc10_Modified2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c10_Modified2(void *chartInstanceVar)
{
  disable_c10_Modified2((SFc10_Modified2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c10_Modified2(void *chartInstanceVar)
{
  sf_gateway_c10_Modified2((SFc10_Modified2InstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c10_Modified2(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c10_Modified2((SFc10_Modified2InstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c10_Modified2(SimStruct* S, const mxArray
  *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c10_Modified2((SFc10_Modified2InstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c10_Modified2(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc10_Modified2InstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c10_Modified2((SFc10_Modified2InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc10_Modified2((SFc10_Modified2InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c10_Modified2(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c10_Modified2(SimStruct *S)
{
...
static void mdlRTW_c10_Modified2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c10_Modified2(SimStruct *S)
{
  SFc10_Modified2InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc10_Modified2InstanceStruct *)utMalloc(sizeof
    (SFc10_Modified2InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc10_Modified2InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c10_Modified2;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c10_Modified2;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c10_Modified2;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c10_Modified2;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c10_Modified2;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c10_Modified2;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c10_Modified2;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c10_Modified2;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c10_Modified2;
  chartInstance->chartInfo.mdlStart = mdlStart_c10_Modified2;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c10_Modified2;
...
void c10_Modified2_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c10_Modified2(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c10_Modified2(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c10_Modified2(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c10_Modified2_method_dispatcher.\n"
