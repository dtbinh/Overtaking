...
static void initialize_c28_Modified2(SFc28_Modified2InstanceStruct
  *chartInstance);
static void initialize_params_c28_Modified2(SFc28_Modified2InstanceStruct
  *chartInstance);
static void enable_c28_Modified2(SFc28_Modified2InstanceStruct *chartInstance);
static void disable_c28_Modified2(SFc28_Modified2InstanceStruct *chartInstance);
static void c28_update_debugger_state_c28_Modified2
  (SFc28_Modified2InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c28_Modified2(SFc28_Modified2InstanceStruct *
  chartInstance);
static void set_sim_state_c28_Modified2(SFc28_Modified2InstanceStruct
  *chartInstance, const mxArray *c28_st);
static void finalize_c28_Modified2(SFc28_Modified2InstanceStruct *chartInstance);
static void sf_gateway_c28_Modified2(SFc28_Modified2InstanceStruct
  *chartInstance);
static void mdl_start_c28_Modified2(SFc28_Modified2InstanceStruct *chartInstance);
static void c28_chartstep_c28_Modified2(SFc28_Modified2InstanceStruct
  *chartInstance);
static void initSimStructsc28_Modified2(SFc28_Modified2InstanceStruct
  *chartInstance);
...
static const mxArray *c28_sf_marshallOut(void *chartInstanceVoid, void
  *c28_inData);
static c28_whl_vec4 c28_emlrt_marshallIn(SFc28_Modified2InstanceStruct
  *chartInstance, const mxArray *c28_b_delta_w4, const char_T *c28_identifier);
static c28_whl_vec4 c28_b_emlrt_marshallIn(SFc28_Modified2InstanceStruct
  *chartInstance, const mxArray *c28_u, const emlrtMsgIdentifier *c28_parentId);
static real_T c28_c_emlrt_marshallIn(SFc28_Modified2InstanceStruct
  *chartInstance, const mxArray *c28_u, const emlrtMsgIdentifier *c28_parentId);
...
static const mxArray *c28_b_sf_marshallOut(void *chartInstanceVoid, void
  *c28_inData);
static void c28_d_emlrt_marshallIn(SFc28_Modified2InstanceStruct *chartInstance,
  const mxArray *c28_u, const emlrtMsgIdentifier *c28_parentId,
  c28_struct_iBlsPBO3AGnt69vDoTx5zD *c28_y);
static void c28_e_emlrt_marshallIn(SFc28_Modified2InstanceStruct *chartInstance,
  const mxArray *c28_u, const emlrtMsgIdentifier *c28_parentId,
  c28_struct_Nst2vGTExxHsg85EUOj9EH *c28_y);
static c28_struct_HhckT6rntEraqECYVIDvCC c28_f_emlrt_marshallIn
  (SFc28_Modified2InstanceStruct *chartInstance, const mxArray *c28_u, const
   emlrtMsgIdentifier *c28_parentId);
static void c28_g_emlrt_marshallIn(SFc28_Modified2InstanceStruct *chartInstance,
  const mxArray *c28_u, const emlrtMsgIdentifier *c28_parentId,
  c28_struct_ZCmOWPuqBDw16FSOVVD00 *c28_y);
static void c28_h_emlrt_marshallIn(SFc28_Modified2InstanceStruct *chartInstance,
  const mxArray *c28_u, const emlrtMsgIdentifier *c28_parentId, real_T c28_y[4]);
static void c28_i_emlrt_marshallIn(SFc28_Modified2InstanceStruct *chartInstance,
  const mxArray *c28_u, const emlrtMsgIdentifier *c28_parentId,
  c28_struct_ZKAzdrl7umDGJoC14aoVKC *c28_y);
static void c28_j_emlrt_marshallIn(SFc28_Modified2InstanceStruct *chartInstance,
...
static void c28_eml_switch_helper(SFc28_Modified2InstanceStruct *chartInstance);
static void c28_check_forloop_overflow_error(SFc28_Modified2InstanceStruct
  *chartInstance, boolean_T c28_overflow);
static const mxArray *c28_e_sf_marshallOut(void *chartInstanceVoid, void
  *c28_inData);
static int32_T c28_m_emlrt_marshallIn(SFc28_Modified2InstanceStruct
  *chartInstance, const mxArray *c28_u, const emlrtMsgIdentifier *c28_parentId);
...
static uint8_T c28_n_emlrt_marshallIn(SFc28_Modified2InstanceStruct
  *chartInstance, const mxArray *c28_b_is_active_c28_Modified2, const char_T
  *c28_identifier);
static uint8_T c28_o_emlrt_marshallIn(SFc28_Modified2InstanceStruct
  *chartInstance, const mxArray *c28_u, const emlrtMsgIdentifier *c28_parentId);
static void init_dsm_address_info(SFc28_Modified2InstanceStruct *chartInstance);
static void init_simulink_io_address(SFc28_Modified2InstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c28_is_active_c28_Modified2 = 0U;
}
  ...
  chartInstance)
{
  ...
  c28_hoistedGlobal = chartInstance->c28_is_active_c28_Modified2;
  ...
  *chartInstance, const mxArray *c28_st)
{
  ...
  *(real_T *)&((char_T *)chartInstance->c28_delta_w4)[24] = c28_r3.rr;
  chartInstance->c28_is_active_c28_Modified2 = c28_n_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c28_u, 3)),
     "is_active_c28_Modified2");
  sf_mex_destroy(&c28_u);
  c28_update_debugger_state_c28_Modified2(chartInstance);
  ...
  *chartInstance)
{
  ...
  _sfTime_ = sf_get_time(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 15U, chartInstance->c28_sfEvent);
  chartInstance->c28_sfEvent = CALL_EVENT;
  c28_chartstep_c28_Modified2(chartInstance);
  ...
  *chartInstance)
{
  ...
  c28_whl_vec4 c28_r6;
  boolean_T exitg1;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 15U, chartInstance->c28_sfEvent);
  ...
  *(real_T *)&((char_T *)chartInstance->c28_delta_w4)[24] = c28_b_delta_w4.rr;
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 15U, chartInstance->c28_sfEvent);
}
  ...
  *c28_inData)
{
  ...
  const mxArray *c28_e_y = NULL;
  SFc28_Modified2InstanceStruct *chartInstance;
  chartInstance = (SFc28_Modified2InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c28_Modified2_get_eml_resolved_functions_info(void)
{
  ...
  *c28_identifier)
{
  ...
  c28_y = c28_o_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c28_b_is_active_c28_Modified2), &c28_thisId);
  sf_mex_destroy(&c28_b_is_active_c28_Modified2);
  return c28_y;
}
...
void sf_c28_Modified2_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c28_Modified2_get_post_codegen_info(void);
mxArray *sf_c28_Modified2_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c28_Modified2_get_post_codegen_info();
...
mxArray *sf_c28_Modified2_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c28_Modified2_jit_fallback_info(void)
{
...
mxArray *sf_c28_Modified2_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c28_Modified2(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[8],T\"T_s4\",},{M[1],M[5],T\"T_us4\",},{M[1],M[20],T\"delta_w4\",},{M[8],M[0],T\"is_active_c28_Modified2\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c28_Modified2_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc28_Modified2InstanceStruct *) chartInfo->chartInstance;
...
static void sf_opaque_initialize_c28_Modified2(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc28_Modified2InstanceStruct*) chartInstanceVar
    )->S,0);
  initialize_params_c28_Modified2((SFc28_Modified2InstanceStruct*)
    chartInstanceVar);
  initialize_c28_Modified2((SFc28_Modified2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c28_Modified2(void *chartInstanceVar)
{
  enable_c28_Modified2((SFc28_Modified2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c28_Modified2(void *chartInstanceVar)
{
  disable_c28_Modified2((SFc28_Modified2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c28_Modified2(void *chartInstanceVar)
{
  sf_gateway_c28_Modified2((SFc28_Modified2InstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c28_Modified2(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c28_Modified2((SFc28_Modified2InstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c28_Modified2(SimStruct* S, const mxArray
  *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c28_Modified2((SFc28_Modified2InstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c28_Modified2(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc28_Modified2InstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c28_Modified2((SFc28_Modified2InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc28_Modified2((SFc28_Modified2InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c28_Modified2(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c28_Modified2(SimStruct *S)
{
...
static void mdlRTW_c28_Modified2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c28_Modified2(SimStruct *S)
{
  SFc28_Modified2InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc28_Modified2InstanceStruct *)utMalloc(sizeof
    (SFc28_Modified2InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc28_Modified2InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c28_Modified2;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c28_Modified2;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c28_Modified2;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c28_Modified2;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c28_Modified2;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c28_Modified2;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c28_Modified2;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c28_Modified2;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c28_Modified2;
  chartInstance->chartInfo.mdlStart = mdlStart_c28_Modified2;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c28_Modified2;
...
void c28_Modified2_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c28_Modified2(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c28_Modified2(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c28_Modified2(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c28_Modified2_method_dispatcher.\n"
