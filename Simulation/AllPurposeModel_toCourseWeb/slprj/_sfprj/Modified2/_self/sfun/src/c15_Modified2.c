...
static void initialize_c15_Modified2(SFc15_Modified2InstanceStruct
  *chartInstance);
static void initialize_params_c15_Modified2(SFc15_Modified2InstanceStruct
  *chartInstance);
static void enable_c15_Modified2(SFc15_Modified2InstanceStruct *chartInstance);
static void disable_c15_Modified2(SFc15_Modified2InstanceStruct *chartInstance);
static void c15_update_debugger_state_c15_Modified2
  (SFc15_Modified2InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c15_Modified2(SFc15_Modified2InstanceStruct *
  chartInstance);
static void set_sim_state_c15_Modified2(SFc15_Modified2InstanceStruct
  *chartInstance, const mxArray *c15_st);
static void finalize_c15_Modified2(SFc15_Modified2InstanceStruct *chartInstance);
static void sf_gateway_c15_Modified2(SFc15_Modified2InstanceStruct
  *chartInstance);
static void mdl_start_c15_Modified2(SFc15_Modified2InstanceStruct *chartInstance);
static void c15_chartstep_c15_Modified2(SFc15_Modified2InstanceStruct
  *chartInstance);
static void initSimStructsc15_Modified2(SFc15_Modified2InstanceStruct
  *chartInstance);
...
static const mxArray *c15_sf_marshallOut(void *chartInstanceVoid, void
  *c15_inData);
static c15_whl_vec4 c15_emlrt_marshallIn(SFc15_Modified2InstanceStruct
  *chartInstance, const mxArray *c15_b_F_yw4, const char_T *c15_identifier);
static c15_whl_vec4 c15_b_emlrt_marshallIn(SFc15_Modified2InstanceStruct
  *chartInstance, const mxArray *c15_u, const emlrtMsgIdentifier *c15_parentId);
static real_T c15_c_emlrt_marshallIn(SFc15_Modified2InstanceStruct
  *chartInstance, const mxArray *c15_u, const emlrtMsgIdentifier *c15_parentId);
...
static const mxArray *c15_b_sf_marshallOut(void *chartInstanceVoid, void
  *c15_inData);
static void c15_d_emlrt_marshallIn(SFc15_Modified2InstanceStruct *chartInstance,
  const mxArray *c15_u, const emlrtMsgIdentifier *c15_parentId,
  c15_struct_iBlsPBO3AGnt69vDoTx5zD *c15_y);
static void c15_e_emlrt_marshallIn(SFc15_Modified2InstanceStruct *chartInstance,
  const mxArray *c15_u, const emlrtMsgIdentifier *c15_parentId,
  c15_struct_Nst2vGTExxHsg85EUOj9EH *c15_y);
static c15_struct_HhckT6rntEraqECYVIDvCC c15_f_emlrt_marshallIn
  (SFc15_Modified2InstanceStruct *chartInstance, const mxArray *c15_u, const
   emlrtMsgIdentifier *c15_parentId);
static void c15_g_emlrt_marshallIn(SFc15_Modified2InstanceStruct *chartInstance,
  const mxArray *c15_u, const emlrtMsgIdentifier *c15_parentId,
  c15_struct_ZCmOWPuqBDw16FSOVVD00 *c15_y);
static void c15_h_emlrt_marshallIn(SFc15_Modified2InstanceStruct *chartInstance,
  const mxArray *c15_u, const emlrtMsgIdentifier *c15_parentId, real_T c15_y[4]);
static void c15_i_emlrt_marshallIn(SFc15_Modified2InstanceStruct *chartInstance,
  const mxArray *c15_u, const emlrtMsgIdentifier *c15_parentId,
  c15_struct_ZKAzdrl7umDGJoC14aoVKC *c15_y);
static void c15_j_emlrt_marshallIn(SFc15_Modified2InstanceStruct *chartInstance,
...
static const mxArray *c15_d_sf_marshallOut(void *chartInstanceVoid, void
  *c15_inData);
static void c15_m_emlrt_marshallIn(SFc15_Modified2InstanceStruct *chartInstance,
  const mxArray *c15_u, const emlrtMsgIdentifier *c15_parentId, real_T c15_y[4]);
...
static const mxArray *c15_e_sf_marshallOut(void *chartInstanceVoid, void
  *c15_inData);
static int32_T c15_n_emlrt_marshallIn(SFc15_Modified2InstanceStruct
  *chartInstance, const mxArray *c15_u, const emlrtMsgIdentifier *c15_parentId);
...
static uint8_T c15_o_emlrt_marshallIn(SFc15_Modified2InstanceStruct
  *chartInstance, const mxArray *c15_b_is_active_c15_Modified2, const char_T
  *c15_identifier);
static uint8_T c15_p_emlrt_marshallIn(SFc15_Modified2InstanceStruct
  *chartInstance, const mxArray *c15_u, const emlrtMsgIdentifier *c15_parentId);
static void init_dsm_address_info(SFc15_Modified2InstanceStruct *chartInstance);
static void init_simulink_io_address(SFc15_Modified2InstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c15_is_active_c15_Modified2 = 0U;
}
  ...
  chartInstance)
{
  ...
  c15_hoistedGlobal = chartInstance->c15_is_active_c15_Modified2;
  ...
  *chartInstance, const mxArray *c15_st)
{
  ...
  *(real_T *)&((char_T *)chartInstance->c15_F_yw4)[24] = c15_r2.rr;
  chartInstance->c15_is_active_c15_Modified2 = c15_o_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c15_u, 2)),
     "is_active_c15_Modified2");
  sf_mex_destroy(&c15_u);
  c15_update_debugger_state_c15_Modified2(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c15_sfEvent = CALL_EVENT;
  c15_chartstep_c15_Modified2(chartInstance);
  ...
  *c15_inData)
{
  ...
  const mxArray *c15_e_y = NULL;
  SFc15_Modified2InstanceStruct *chartInstance;
  chartInstance = (SFc15_Modified2InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c15_Modified2_get_eml_resolved_functions_info(void)
{
  ...
  *c15_identifier)
{
  ...
  c15_y = c15_p_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c15_b_is_active_c15_Modified2), &c15_thisId);
  sf_mex_destroy(&c15_b_is_active_c15_Modified2);
  return c15_y;
}
...
void sf_c15_Modified2_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c15_Modified2_get_post_codegen_info(void);
mxArray *sf_c15_Modified2_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c15_Modified2_get_post_codegen_info();
...
mxArray *sf_c15_Modified2_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c15_Modified2_jit_fallback_info(void)
{
...
mxArray *sf_c15_Modified2_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c15_Modified2(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[49],T\"F_xw4\",},{M[1],M[50],T\"F_yw4\",},{M[8],M[0],T\"is_active_c15_Modified2\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c15_Modified2_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc15_Modified2InstanceStruct *) chartInfo->chartInstance;
...
static void sf_opaque_initialize_c15_Modified2(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc15_Modified2InstanceStruct*) chartInstanceVar
    )->S,0);
  initialize_params_c15_Modified2((SFc15_Modified2InstanceStruct*)
    chartInstanceVar);
  initialize_c15_Modified2((SFc15_Modified2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c15_Modified2(void *chartInstanceVar)
{
  enable_c15_Modified2((SFc15_Modified2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c15_Modified2(void *chartInstanceVar)
{
  disable_c15_Modified2((SFc15_Modified2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c15_Modified2(void *chartInstanceVar)
{
  sf_gateway_c15_Modified2((SFc15_Modified2InstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c15_Modified2(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c15_Modified2((SFc15_Modified2InstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c15_Modified2(SimStruct* S, const mxArray
  *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c15_Modified2((SFc15_Modified2InstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c15_Modified2(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc15_Modified2InstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c15_Modified2((SFc15_Modified2InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc15_Modified2((SFc15_Modified2InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c15_Modified2(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c15_Modified2(SimStruct *S)
{
...
static void mdlRTW_c15_Modified2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c15_Modified2(SimStruct *S)
{
  SFc15_Modified2InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc15_Modified2InstanceStruct *)utMalloc(sizeof
    (SFc15_Modified2InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc15_Modified2InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c15_Modified2;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c15_Modified2;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c15_Modified2;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c15_Modified2;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c15_Modified2;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c15_Modified2;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c15_Modified2;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c15_Modified2;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c15_Modified2;
  chartInstance->chartInfo.mdlStart = mdlStart_c15_Modified2;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c15_Modified2;
...
void c15_Modified2_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c15_Modified2(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c15_Modified2(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c15_Modified2(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c15_Modified2_method_dispatcher.\n"
