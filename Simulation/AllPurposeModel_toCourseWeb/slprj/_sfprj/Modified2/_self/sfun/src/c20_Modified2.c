...
static void initialize_c20_Modified2(SFc20_Modified2InstanceStruct
  *chartInstance);
static void initialize_params_c20_Modified2(SFc20_Modified2InstanceStruct
  *chartInstance);
static void enable_c20_Modified2(SFc20_Modified2InstanceStruct *chartInstance);
static void disable_c20_Modified2(SFc20_Modified2InstanceStruct *chartInstance);
static void c20_update_debugger_state_c20_Modified2
  (SFc20_Modified2InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c20_Modified2(SFc20_Modified2InstanceStruct *
  chartInstance);
static void set_sim_state_c20_Modified2(SFc20_Modified2InstanceStruct
  *chartInstance, const mxArray *c20_st);
static void finalize_c20_Modified2(SFc20_Modified2InstanceStruct *chartInstance);
static void sf_gateway_c20_Modified2(SFc20_Modified2InstanceStruct
  *chartInstance);
static void mdl_start_c20_Modified2(SFc20_Modified2InstanceStruct *chartInstance);
static void c20_chartstep_c20_Modified2(SFc20_Modified2InstanceStruct
  *chartInstance);
static void initSimStructsc20_Modified2(SFc20_Modified2InstanceStruct
  *chartInstance);
...
static const mxArray *c20_sf_marshallOut(void *chartInstanceVoid, void
  *c20_inData);
static c20_whl_vec4 c20_emlrt_marshallIn(SFc20_Modified2InstanceStruct
  *chartInstance, const mxArray *c20_b_v_yw4, const char_T *c20_identifier);
static c20_whl_vec4 c20_b_emlrt_marshallIn(SFc20_Modified2InstanceStruct
  *chartInstance, const mxArray *c20_u, const emlrtMsgIdentifier *c20_parentId);
static real_T c20_c_emlrt_marshallIn(SFc20_Modified2InstanceStruct
  *chartInstance, const mxArray *c20_u, const emlrtMsgIdentifier *c20_parentId);
...
static const mxArray *c20_c_sf_marshallOut(void *chartInstanceVoid, void
  *c20_inData);
static void c20_d_emlrt_marshallIn(SFc20_Modified2InstanceStruct *chartInstance,
...
static const mxArray *c20_d_sf_marshallOut(void *chartInstanceVoid, void
  *c20_inData);
static void c20_e_emlrt_marshallIn(SFc20_Modified2InstanceStruct *chartInstance,
...
static void c20_eml_scalar_eg(SFc20_Modified2InstanceStruct *chartInstance);
static void c20_eml_xgemm(SFc20_Modified2InstanceStruct *chartInstance, real_T
...
static const mxArray *c20_e_sf_marshallOut(void *chartInstanceVoid, void
  *c20_inData);
static int32_T c20_f_emlrt_marshallIn(SFc20_Modified2InstanceStruct
  *chartInstance, const mxArray *c20_u, const emlrtMsgIdentifier *c20_parentId);
...
static uint8_T c20_g_emlrt_marshallIn(SFc20_Modified2InstanceStruct
  *chartInstance, const mxArray *c20_b_is_active_c20_Modified2, const char_T
  *c20_identifier);
static uint8_T c20_h_emlrt_marshallIn(SFc20_Modified2InstanceStruct
  *chartInstance, const mxArray *c20_u, const emlrtMsgIdentifier *c20_parentId);
static void c20_b_eml_xgemm(SFc20_Modified2InstanceStruct *chartInstance, real_T
  c20_A[4], real_T c20_B[2], real_T c20_C[2]);
static void init_dsm_address_info(SFc20_Modified2InstanceStruct *chartInstance);
static void init_simulink_io_address(SFc20_Modified2InstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c20_is_active_c20_Modified2 = 0U;
}
  ...
  chartInstance)
{
  ...
  c20_hoistedGlobal = chartInstance->c20_is_active_c20_Modified2;
  ...
  *chartInstance, const mxArray *c20_st)
{
  ...
  *(real_T *)&((char_T *)chartInstance->c20_v_yw4)[24] = c20_r1.rr;
  chartInstance->c20_is_active_c20_Modified2 = c20_g_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c20_u, 2)),
     "is_active_c20_Modified2");
  sf_mex_destroy(&c20_u);
  c20_update_debugger_state_c20_Modified2(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c20_sfEvent = CALL_EVENT;
  c20_chartstep_c20_Modified2(chartInstance);
  ...
  *c20_inData)
{
  ...
  const mxArray *c20_e_y = NULL;
  SFc20_Modified2InstanceStruct *chartInstance;
  chartInstance = (SFc20_Modified2InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c20_Modified2_get_eml_resolved_functions_info(void)
{
  ...
  *c20_identifier)
{
  ...
  c20_y = c20_h_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c20_b_is_active_c20_Modified2), &c20_thisId);
  sf_mex_destroy(&c20_b_is_active_c20_Modified2);
  return c20_y;
}
...
void sf_c20_Modified2_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c20_Modified2_get_post_codegen_info(void);
mxArray *sf_c20_Modified2_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c20_Modified2_get_post_codegen_info();
...
mxArray *sf_c20_Modified2_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c20_Modified2_jit_fallback_info(void)
{
...
mxArray *sf_c20_Modified2_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c20_Modified2(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"v_xw4\",},{M[1],M[6],T\"v_yw4\",},{M[8],M[0],T\"is_active_c20_Modified2\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c20_Modified2_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc20_Modified2InstanceStruct *) chartInfo->chartInstance;
...
static void sf_opaque_initialize_c20_Modified2(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc20_Modified2InstanceStruct*) chartInstanceVar
    )->S,0);
  initialize_params_c20_Modified2((SFc20_Modified2InstanceStruct*)
    chartInstanceVar);
  initialize_c20_Modified2((SFc20_Modified2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c20_Modified2(void *chartInstanceVar)
{
  enable_c20_Modified2((SFc20_Modified2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c20_Modified2(void *chartInstanceVar)
{
  disable_c20_Modified2((SFc20_Modified2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c20_Modified2(void *chartInstanceVar)
{
  sf_gateway_c20_Modified2((SFc20_Modified2InstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c20_Modified2(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c20_Modified2((SFc20_Modified2InstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c20_Modified2(SimStruct* S, const mxArray
  *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c20_Modified2((SFc20_Modified2InstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c20_Modified2(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc20_Modified2InstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c20_Modified2((SFc20_Modified2InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc20_Modified2((SFc20_Modified2InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c20_Modified2(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c20_Modified2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c20_Modified2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c20_Modified2(SimStruct *S)
{
  SFc20_Modified2InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc20_Modified2InstanceStruct *)utMalloc(sizeof
    (SFc20_Modified2InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc20_Modified2InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c20_Modified2;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c20_Modified2;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c20_Modified2;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c20_Modified2;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c20_Modified2;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c20_Modified2;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c20_Modified2;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c20_Modified2;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c20_Modified2;
  chartInstance->chartInfo.mdlStart = mdlStart_c20_Modified2;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c20_Modified2;
...
void c20_Modified2_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c20_Modified2(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c20_Modified2(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c20_Modified2(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c20_Modified2_method_dispatcher.\n"
