...
static void initialize_c5_Modified2(SFc5_Modified2InstanceStruct *chartInstance);
static void initialize_params_c5_Modified2(SFc5_Modified2InstanceStruct
  *chartInstance);
static void enable_c5_Modified2(SFc5_Modified2InstanceStruct *chartInstance);
static void disable_c5_Modified2(SFc5_Modified2InstanceStruct *chartInstance);
static void c5_update_debugger_state_c5_Modified2(SFc5_Modified2InstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c5_Modified2(SFc5_Modified2InstanceStruct
  *chartInstance);
static void set_sim_state_c5_Modified2(SFc5_Modified2InstanceStruct
  *chartInstance, const mxArray *c5_st);
static void finalize_c5_Modified2(SFc5_Modified2InstanceStruct *chartInstance);
static void sf_gateway_c5_Modified2(SFc5_Modified2InstanceStruct *chartInstance);
static void mdl_start_c5_Modified2(SFc5_Modified2InstanceStruct *chartInstance);
static void initSimStructsc5_Modified2(SFc5_Modified2InstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c5_machineNumber, uint32_T
  c5_chartNumber, uint32_T c5_instanceNumber);
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData);
static c5_whl_vec4 c5_emlrt_marshallIn(SFc5_Modified2InstanceStruct
  *chartInstance, const mxArray *c5_b_F_z4, const char_T *c5_identifier);
static c5_whl_vec4 c5_b_emlrt_marshallIn(SFc5_Modified2InstanceStruct
  *chartInstance, const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static real_T c5_c_emlrt_marshallIn(SFc5_Modified2InstanceStruct *chartInstance,
  const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void c5_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData);
static const mxArray *c5_b_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static void c5_d_emlrt_marshallIn(SFc5_Modified2InstanceStruct *chartInstance,
  const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId,
  c5_struct_iBlsPBO3AGnt69vDoTx5zD *c5_y);
static void c5_e_emlrt_marshallIn(SFc5_Modified2InstanceStruct *chartInstance,
  const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId,
  c5_struct_Nst2vGTExxHsg85EUOj9EH *c5_y);
static c5_struct_HhckT6rntEraqECYVIDvCC c5_f_emlrt_marshallIn
  (SFc5_Modified2InstanceStruct *chartInstance, const mxArray *c5_u, const
   emlrtMsgIdentifier *c5_parentId);
static void c5_g_emlrt_marshallIn(SFc5_Modified2InstanceStruct *chartInstance,
  const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId,
  c5_struct_ZCmOWPuqBDw16FSOVVD00 *c5_y);
static void c5_h_emlrt_marshallIn(SFc5_Modified2InstanceStruct *chartInstance,
  const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId, real_T c5_y[4]);
static void c5_i_emlrt_marshallIn(SFc5_Modified2InstanceStruct *chartInstance,
  const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId,
  c5_struct_ZKAzdrl7umDGJoC14aoVKC *c5_y);
static void c5_j_emlrt_marshallIn(SFc5_Modified2InstanceStruct *chartInstance,
...
static const mxArray *c5_d_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static int32_T c5_m_emlrt_marshallIn(SFc5_Modified2InstanceStruct *chartInstance,
  const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void c5_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData);
static const mxArray *c5_T_s4_bus_io(void *chartInstanceVoid, void *c5_pData);
static uint8_T c5_n_emlrt_marshallIn(SFc5_Modified2InstanceStruct *chartInstance,
  const mxArray *c5_b_is_active_c5_Modified2, const char_T *c5_identifier);
static uint8_T c5_o_emlrt_marshallIn(SFc5_Modified2InstanceStruct *chartInstance,
  const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void init_dsm_address_info(SFc5_Modified2InstanceStruct *chartInstance);
static void init_simulink_io_address(SFc5_Modified2InstanceStruct *chartInstance);
...
static void initialize_c5_Modified2(SFc5_Modified2InstanceStruct *chartInstance)
{
  ...
  chartInstance->c5_is_active_c5_Modified2 = 0U;
}
  ...
  *chartInstance)
{
  ...
  c5_hoistedGlobal = chartInstance->c5_is_active_c5_Modified2;
  ...
  *chartInstance, const mxArray *c5_st)
{
  ...
  *(real_T *)&((char_T *)chartInstance->c5_F_z4)[24] = c5_r1.rr;
  chartInstance->c5_is_active_c5_Modified2 = c5_n_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c5_u, 1)), "is_active_c5_Modified2");
  sf_mex_destroy(&c5_u);
  c5_update_debugger_state_c5_Modified2(chartInstance);
...
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData)
{
  ...
  real_T c5_e_u;
  const mxArray *c5_e_y = NULL;
  SFc5_Modified2InstanceStruct *chartInstance;
  chartInstance = (SFc5_Modified2InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c5_Modified2_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c5_b_is_active_c5_Modified2, const char_T *c5_identifier)
{
  ...
  c5_y = c5_o_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c5_b_is_active_c5_Modified2), &c5_thisId);
  sf_mex_destroy(&c5_b_is_active_c5_Modified2);
  return c5_y;
}
...
void sf_c5_Modified2_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c5_Modified2_get_post_codegen_info(void);
mxArray *sf_c5_Modified2_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c5_Modified2_get_post_codegen_info();
...
mxArray *sf_c5_Modified2_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c5_Modified2_jit_fallback_info(void)
{
...
mxArray *sf_c5_Modified2_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c5_Modified2(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[7],T\"F_z4\",},{M[8],M[0],T\"is_active_c5_Modified2\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c5_Modified2_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc5_Modified2InstanceStruct *) chartInfo->chartInstance;
...
static void sf_opaque_initialize_c5_Modified2(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc5_Modified2InstanceStruct*) chartInstanceVar
    )->S,0);
  initialize_params_c5_Modified2((SFc5_Modified2InstanceStruct*)
    chartInstanceVar);
  initialize_c5_Modified2((SFc5_Modified2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c5_Modified2(void *chartInstanceVar)
{
  enable_c5_Modified2((SFc5_Modified2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c5_Modified2(void *chartInstanceVar)
{
  disable_c5_Modified2((SFc5_Modified2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c5_Modified2(void *chartInstanceVar)
{
  sf_gateway_c5_Modified2((SFc5_Modified2InstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c5_Modified2(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c5_Modified2((SFc5_Modified2InstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c5_Modified2(SimStruct* S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c5_Modified2((SFc5_Modified2InstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c5_Modified2(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc5_Modified2InstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c5_Modified2((SFc5_Modified2InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc5_Modified2((SFc5_Modified2InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c5_Modified2(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c5_Modified2(SimStruct *S)
{
...
static void mdlRTW_c5_Modified2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c5_Modified2(SimStruct *S)
{
  SFc5_Modified2InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc5_Modified2InstanceStruct *)utMalloc(sizeof
    (SFc5_Modified2InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc5_Modified2InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c5_Modified2;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c5_Modified2;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c5_Modified2;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c5_Modified2;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c5_Modified2;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c5_Modified2;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c5_Modified2;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c5_Modified2;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c5_Modified2;
  chartInstance->chartInfo.mdlStart = mdlStart_c5_Modified2;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c5_Modified2;
...
void c5_Modified2_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c5_Modified2(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c5_Modified2(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c5_Modified2(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c5_Modified2_method_dispatcher.\n"
