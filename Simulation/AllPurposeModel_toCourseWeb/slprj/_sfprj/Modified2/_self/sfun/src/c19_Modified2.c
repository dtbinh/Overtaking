...
static void initialize_c19_Modified2(SFc19_Modified2InstanceStruct
  *chartInstance);
static void initialize_params_c19_Modified2(SFc19_Modified2InstanceStruct
  *chartInstance);
static void enable_c19_Modified2(SFc19_Modified2InstanceStruct *chartInstance);
static void disable_c19_Modified2(SFc19_Modified2InstanceStruct *chartInstance);
static void c19_update_debugger_state_c19_Modified2
  (SFc19_Modified2InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c19_Modified2(SFc19_Modified2InstanceStruct *
  chartInstance);
static void set_sim_state_c19_Modified2(SFc19_Modified2InstanceStruct
  *chartInstance, const mxArray *c19_st);
static void finalize_c19_Modified2(SFc19_Modified2InstanceStruct *chartInstance);
static void sf_gateway_c19_Modified2(SFc19_Modified2InstanceStruct
  *chartInstance);
static void mdl_start_c19_Modified2(SFc19_Modified2InstanceStruct *chartInstance);
static void c19_chartstep_c19_Modified2(SFc19_Modified2InstanceStruct
  *chartInstance);
static void initSimStructsc19_Modified2(SFc19_Modified2InstanceStruct
  *chartInstance);
...
static const mxArray *c19_sf_marshallOut(void *chartInstanceVoid, void
  *c19_inData);
static c19_whl_vec4 c19_emlrt_marshallIn(SFc19_Modified2InstanceStruct
  *chartInstance, const mxArray *c19_b_F_yv4, const char_T *c19_identifier);
static c19_whl_vec4 c19_b_emlrt_marshallIn(SFc19_Modified2InstanceStruct
  *chartInstance, const mxArray *c19_u, const emlrtMsgIdentifier *c19_parentId);
static real_T c19_c_emlrt_marshallIn(SFc19_Modified2InstanceStruct
  *chartInstance, const mxArray *c19_u, const emlrtMsgIdentifier *c19_parentId);
...
static const mxArray *c19_c_sf_marshallOut(void *chartInstanceVoid, void
  *c19_inData);
static void c19_d_emlrt_marshallIn(SFc19_Modified2InstanceStruct *chartInstance,
...
static void c19_eml_scalar_eg(SFc19_Modified2InstanceStruct *chartInstance);
static void c19_eml_xgemm(SFc19_Modified2InstanceStruct *chartInstance, real_T
...
static const mxArray *c19_d_sf_marshallOut(void *chartInstanceVoid, void
  *c19_inData);
static int32_T c19_e_emlrt_marshallIn(SFc19_Modified2InstanceStruct
  *chartInstance, const mxArray *c19_u, const emlrtMsgIdentifier *c19_parentId);
...
static uint8_T c19_f_emlrt_marshallIn(SFc19_Modified2InstanceStruct
  *chartInstance, const mxArray *c19_b_is_active_c19_Modified2, const char_T
  *c19_identifier);
static uint8_T c19_g_emlrt_marshallIn(SFc19_Modified2InstanceStruct
  *chartInstance, const mxArray *c19_u, const emlrtMsgIdentifier *c19_parentId);
static void c19_b_eml_xgemm(SFc19_Modified2InstanceStruct *chartInstance, real_T
  c19_A[4], real_T c19_B[2], real_T c19_C[2]);
static void init_dsm_address_info(SFc19_Modified2InstanceStruct *chartInstance);
static void init_simulink_io_address(SFc19_Modified2InstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c19_is_active_c19_Modified2 = 0U;
}
  ...
  chartInstance)
{
  ...
  c19_hoistedGlobal = chartInstance->c19_is_active_c19_Modified2;
  ...
  *chartInstance, const mxArray *c19_st)
{
  ...
  *(real_T *)&((char_T *)chartInstance->c19_F_yv4)[24] = c19_r1.rr;
  chartInstance->c19_is_active_c19_Modified2 = c19_f_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c19_u, 2)),
     "is_active_c19_Modified2");
  sf_mex_destroy(&c19_u);
  c19_update_debugger_state_c19_Modified2(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c19_sfEvent = CALL_EVENT;
  c19_chartstep_c19_Modified2(chartInstance);
  ...
  *c19_inData)
{
  ...
  const mxArray *c19_e_y = NULL;
  SFc19_Modified2InstanceStruct *chartInstance;
  chartInstance = (SFc19_Modified2InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c19_Modified2_get_eml_resolved_functions_info(void)
{
  ...
  *c19_identifier)
{
  ...
  c19_y = c19_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c19_b_is_active_c19_Modified2), &c19_thisId);
  sf_mex_destroy(&c19_b_is_active_c19_Modified2);
  return c19_y;
}
...
void sf_c19_Modified2_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c19_Modified2_get_post_codegen_info(void);
mxArray *sf_c19_Modified2_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c19_Modified2_get_post_codegen_info();
...
mxArray *sf_c19_Modified2_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c19_Modified2_jit_fallback_info(void)
{
...
mxArray *sf_c19_Modified2_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c19_Modified2(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"F_xv4\",},{M[1],M[7],T\"F_yv4\",},{M[8],M[0],T\"is_active_c19_Modified2\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c19_Modified2_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc19_Modified2InstanceStruct *) chartInfo->chartInstance;
...
static void sf_opaque_initialize_c19_Modified2(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc19_Modified2InstanceStruct*) chartInstanceVar
    )->S,0);
  initialize_params_c19_Modified2((SFc19_Modified2InstanceStruct*)
    chartInstanceVar);
  initialize_c19_Modified2((SFc19_Modified2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c19_Modified2(void *chartInstanceVar)
{
  enable_c19_Modified2((SFc19_Modified2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c19_Modified2(void *chartInstanceVar)
{
  disable_c19_Modified2((SFc19_Modified2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c19_Modified2(void *chartInstanceVar)
{
  sf_gateway_c19_Modified2((SFc19_Modified2InstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c19_Modified2(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c19_Modified2((SFc19_Modified2InstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c19_Modified2(SimStruct* S, const mxArray
  *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c19_Modified2((SFc19_Modified2InstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c19_Modified2(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc19_Modified2InstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c19_Modified2((SFc19_Modified2InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc19_Modified2((SFc19_Modified2InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c19_Modified2(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c19_Modified2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c19_Modified2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c19_Modified2(SimStruct *S)
{
  SFc19_Modified2InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc19_Modified2InstanceStruct *)utMalloc(sizeof
    (SFc19_Modified2InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc19_Modified2InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c19_Modified2;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c19_Modified2;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c19_Modified2;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c19_Modified2;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c19_Modified2;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c19_Modified2;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c19_Modified2;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c19_Modified2;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c19_Modified2;
  chartInstance->chartInfo.mdlStart = mdlStart_c19_Modified2;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c19_Modified2;
...
void c19_Modified2_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c19_Modified2(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c19_Modified2(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c19_Modified2(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c19_Modified2_method_dispatcher.\n"
