...
static void initialize_c3_Modified2(SFc3_Modified2InstanceStruct *chartInstance);
static void initialize_params_c3_Modified2(SFc3_Modified2InstanceStruct
  *chartInstance);
static void enable_c3_Modified2(SFc3_Modified2InstanceStruct *chartInstance);
static void disable_c3_Modified2(SFc3_Modified2InstanceStruct *chartInstance);
static void c3_update_debugger_state_c3_Modified2(SFc3_Modified2InstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c3_Modified2(SFc3_Modified2InstanceStruct
  *chartInstance);
static void set_sim_state_c3_Modified2(SFc3_Modified2InstanceStruct
  *chartInstance, const mxArray *c3_st);
static void finalize_c3_Modified2(SFc3_Modified2InstanceStruct *chartInstance);
static void sf_gateway_c3_Modified2(SFc3_Modified2InstanceStruct *chartInstance);
static void mdl_start_c3_Modified2(SFc3_Modified2InstanceStruct *chartInstance);
static void c3_chartstep_c3_Modified2(SFc3_Modified2InstanceStruct
  *chartInstance);
static void initSimStructsc3_Modified2(SFc3_Modified2InstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c3_machineNumber, uint32_T
  c3_chartNumber, uint32_T c3_instanceNumber);
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData);
static c3_whl_vec4 c3_emlrt_marshallIn(SFc3_Modified2InstanceStruct
  *chartInstance, const mxArray *c3_b_s_xy4, const char_T *c3_identifier);
static c3_whl_vec4 c3_b_emlrt_marshallIn(SFc3_Modified2InstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static real_T c3_c_emlrt_marshallIn(SFc3_Modified2InstanceStruct *chartInstance,
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static const mxArray *c3_b_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static void c3_d_emlrt_marshallIn(SFc3_Modified2InstanceStruct *chartInstance,
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId,
  c3_struct_iBlsPBO3AGnt69vDoTx5zD *c3_y);
static void c3_e_emlrt_marshallIn(SFc3_Modified2InstanceStruct *chartInstance,
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId,
  c3_struct_Nst2vGTExxHsg85EUOj9EH *c3_y);
static c3_struct_HhckT6rntEraqECYVIDvCC c3_f_emlrt_marshallIn
  (SFc3_Modified2InstanceStruct *chartInstance, const mxArray *c3_u, const
   emlrtMsgIdentifier *c3_parentId);
static void c3_g_emlrt_marshallIn(SFc3_Modified2InstanceStruct *chartInstance,
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId,
  c3_struct_ZCmOWPuqBDw16FSOVVD00 *c3_y);
static void c3_h_emlrt_marshallIn(SFc3_Modified2InstanceStruct *chartInstance,
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId, real_T c3_y[4]);
static void c3_i_emlrt_marshallIn(SFc3_Modified2InstanceStruct *chartInstance,
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId,
  c3_struct_ZKAzdrl7umDGJoC14aoVKC *c3_y);
static void c3_j_emlrt_marshallIn(SFc3_Modified2InstanceStruct *chartInstance,
...
static real_T c3_abs(SFc3_Modified2InstanceStruct *chartInstance, real_T c3_x);
static real_T c3_mpower(SFc3_Modified2InstanceStruct *chartInstance, real_T c3_a);
static void c3_eml_scalar_eg(SFc3_Modified2InstanceStruct *chartInstance);
static void c3_eml_error(SFc3_Modified2InstanceStruct *chartInstance);
static const mxArray *c3_d_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static int32_T c3_m_emlrt_marshallIn(SFc3_Modified2InstanceStruct *chartInstance,
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static const mxArray *c3_w_4_bus_io(void *chartInstanceVoid, void *c3_pData);
static uint8_T c3_n_emlrt_marshallIn(SFc3_Modified2InstanceStruct *chartInstance,
  const mxArray *c3_b_is_active_c3_Modified2, const char_T *c3_identifier);
static uint8_T c3_o_emlrt_marshallIn(SFc3_Modified2InstanceStruct *chartInstance,
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void init_dsm_address_info(SFc3_Modified2InstanceStruct *chartInstance);
static void init_simulink_io_address(SFc3_Modified2InstanceStruct *chartInstance);
...
static void initialize_c3_Modified2(SFc3_Modified2InstanceStruct *chartInstance)
{
  ...
  chartInstance->c3_is_active_c3_Modified2 = 0U;
}
  ...
  *chartInstance)
{
  ...
  c3_hoistedGlobal = chartInstance->c3_is_active_c3_Modified2;
  ...
  *chartInstance, const mxArray *c3_st)
{
  ...
  *(real_T *)&((char_T *)chartInstance->c3_s_y4)[24] = c3_r3.rr;
  chartInstance->c3_is_active_c3_Modified2 = c3_n_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c3_u, 3)), "is_active_c3_Modified2");
  sf_mex_destroy(&c3_u);
  c3_update_debugger_state_c3_Modified2(chartInstance);
...
static void sf_gateway_c3_Modified2(SFc3_Modified2InstanceStruct *chartInstance)
{
  ...
  chartInstance->c3_sfEvent = CALL_EVENT;
  c3_chartstep_c3_Modified2(chartInstance);
...
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData)
{
  ...
  real_T c3_e_u;
  const mxArray *c3_e_y = NULL;
  SFc3_Modified2InstanceStruct *chartInstance;
  chartInstance = (SFc3_Modified2InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c3_Modified2_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c3_b_is_active_c3_Modified2, const char_T *c3_identifier)
{
  ...
  c3_y = c3_o_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c3_b_is_active_c3_Modified2), &c3_thisId);
  sf_mex_destroy(&c3_b_is_active_c3_Modified2);
  return c3_y;
}
...
void sf_c3_Modified2_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c3_Modified2_get_post_codegen_info(void);
mxArray *sf_c3_Modified2_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c3_Modified2_get_post_codegen_info();
...
mxArray *sf_c3_Modified2_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c3_Modified2_jit_fallback_info(void)
{
...
mxArray *sf_c3_Modified2_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c3_Modified2(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[11],T\"s_x4\",},{M[1],M[48],T\"s_xy4\",},{M[1],M[12],T\"s_y4\",},{M[8],M[0],T\"is_active_c3_Modified2\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c3_Modified2_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc3_Modified2InstanceStruct *) chartInfo->chartInstance;
...
static void sf_opaque_initialize_c3_Modified2(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc3_Modified2InstanceStruct*) chartInstanceVar
    )->S,0);
  initialize_params_c3_Modified2((SFc3_Modified2InstanceStruct*)
    chartInstanceVar);
  initialize_c3_Modified2((SFc3_Modified2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c3_Modified2(void *chartInstanceVar)
{
  enable_c3_Modified2((SFc3_Modified2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c3_Modified2(void *chartInstanceVar)
{
  disable_c3_Modified2((SFc3_Modified2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c3_Modified2(void *chartInstanceVar)
{
  sf_gateway_c3_Modified2((SFc3_Modified2InstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c3_Modified2(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c3_Modified2((SFc3_Modified2InstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c3_Modified2(SimStruct* S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c3_Modified2((SFc3_Modified2InstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c3_Modified2(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc3_Modified2InstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c3_Modified2((SFc3_Modified2InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc3_Modified2((SFc3_Modified2InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_Modified2(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c3_Modified2(SimStruct *S)
{
...
static void mdlRTW_c3_Modified2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c3_Modified2(SimStruct *S)
{
  SFc3_Modified2InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc3_Modified2InstanceStruct *)utMalloc(sizeof
    (SFc3_Modified2InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc3_Modified2InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c3_Modified2;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c3_Modified2;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c3_Modified2;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c3_Modified2;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c3_Modified2;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c3_Modified2;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c3_Modified2;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c3_Modified2;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c3_Modified2;
  chartInstance->chartInfo.mdlStart = mdlStart_c3_Modified2;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c3_Modified2;
...
void c3_Modified2_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_Modified2(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_Modified2(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_Modified2(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_Modified2_method_dispatcher.\n"
