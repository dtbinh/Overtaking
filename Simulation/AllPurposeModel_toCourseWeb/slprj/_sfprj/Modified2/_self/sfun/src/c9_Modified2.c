...
static void initialize_c9_Modified2(SFc9_Modified2InstanceStruct *chartInstance);
static void initialize_params_c9_Modified2(SFc9_Modified2InstanceStruct
  *chartInstance);
static void enable_c9_Modified2(SFc9_Modified2InstanceStruct *chartInstance);
static void disable_c9_Modified2(SFc9_Modified2InstanceStruct *chartInstance);
static void c9_update_debugger_state_c9_Modified2(SFc9_Modified2InstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c9_Modified2(SFc9_Modified2InstanceStruct
  *chartInstance);
static void set_sim_state_c9_Modified2(SFc9_Modified2InstanceStruct
  *chartInstance, const mxArray *c9_st);
static void finalize_c9_Modified2(SFc9_Modified2InstanceStruct *chartInstance);
static void sf_gateway_c9_Modified2(SFc9_Modified2InstanceStruct *chartInstance);
static void mdl_start_c9_Modified2(SFc9_Modified2InstanceStruct *chartInstance);
static void initSimStructsc9_Modified2(SFc9_Modified2InstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c9_machineNumber, uint32_T
  c9_chartNumber, uint32_T c9_instanceNumber);
static const mxArray *c9_sf_marshallOut(void *chartInstanceVoid, void *c9_inData);
static c9_whl_vec4 c9_emlrt_marshallIn(SFc9_Modified2InstanceStruct
  *chartInstance, const mxArray *c9_b_F_d4, const char_T *c9_identifier);
static c9_whl_vec4 c9_b_emlrt_marshallIn(SFc9_Modified2InstanceStruct
  *chartInstance, const mxArray *c9_u, const emlrtMsgIdentifier *c9_parentId);
static real_T c9_c_emlrt_marshallIn(SFc9_Modified2InstanceStruct *chartInstance,
  const mxArray *c9_u, const emlrtMsgIdentifier *c9_parentId);
static void c9_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c9_mxArrayInData, const char_T *c9_varName, void *c9_outData);
static const mxArray *c9_b_sf_marshallOut(void *chartInstanceVoid, void
  *c9_inData);
static void c9_d_emlrt_marshallIn(SFc9_Modified2InstanceStruct *chartInstance,
  const mxArray *c9_u, const emlrtMsgIdentifier *c9_parentId,
  c9_struct_iBlsPBO3AGnt69vDoTx5zD *c9_y);
static void c9_e_emlrt_marshallIn(SFc9_Modified2InstanceStruct *chartInstance,
  const mxArray *c9_u, const emlrtMsgIdentifier *c9_parentId,
  c9_struct_Nst2vGTExxHsg85EUOj9EH *c9_y);
static c9_struct_HhckT6rntEraqECYVIDvCC c9_f_emlrt_marshallIn
  (SFc9_Modified2InstanceStruct *chartInstance, const mxArray *c9_u, const
   emlrtMsgIdentifier *c9_parentId);
static void c9_g_emlrt_marshallIn(SFc9_Modified2InstanceStruct *chartInstance,
  const mxArray *c9_u, const emlrtMsgIdentifier *c9_parentId,
  c9_struct_ZCmOWPuqBDw16FSOVVD00 *c9_y);
static void c9_h_emlrt_marshallIn(SFc9_Modified2InstanceStruct *chartInstance,
  const mxArray *c9_u, const emlrtMsgIdentifier *c9_parentId, real_T c9_y[4]);
static void c9_i_emlrt_marshallIn(SFc9_Modified2InstanceStruct *chartInstance,
  const mxArray *c9_u, const emlrtMsgIdentifier *c9_parentId,
  c9_struct_ZKAzdrl7umDGJoC14aoVKC *c9_y);
static void c9_j_emlrt_marshallIn(SFc9_Modified2InstanceStruct *chartInstance,
...
static const mxArray *c9_d_sf_marshallOut(void *chartInstanceVoid, void
  *c9_inData);
static int32_T c9_m_emlrt_marshallIn(SFc9_Modified2InstanceStruct *chartInstance,
  const mxArray *c9_u, const emlrtMsgIdentifier *c9_parentId);
...
static uint8_T c9_n_emlrt_marshallIn(SFc9_Modified2InstanceStruct *chartInstance,
  const mxArray *c9_b_is_active_c9_Modified2, const char_T *c9_identifier);
static uint8_T c9_o_emlrt_marshallIn(SFc9_Modified2InstanceStruct *chartInstance,
  const mxArray *c9_u, const emlrtMsgIdentifier *c9_parentId);
static void init_dsm_address_info(SFc9_Modified2InstanceStruct *chartInstance);
static void init_simulink_io_address(SFc9_Modified2InstanceStruct *chartInstance);
...
static void initialize_c9_Modified2(SFc9_Modified2InstanceStruct *chartInstance)
{
  ...
  chartInstance->c9_is_active_c9_Modified2 = 0U;
}
  ...
  *chartInstance)
{
  ...
  c9_hoistedGlobal = chartInstance->c9_is_active_c9_Modified2;
  ...
  *chartInstance, const mxArray *c9_st)
{
  ...
  *(real_T *)&((char_T *)chartInstance->c9_F_d4)[24] = c9_r1.rr;
  chartInstance->c9_is_active_c9_Modified2 = c9_n_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c9_u, 1)), "is_active_c9_Modified2");
  sf_mex_destroy(&c9_u);
  c9_update_debugger_state_c9_Modified2(chartInstance);
...
static const mxArray *c9_sf_marshallOut(void *chartInstanceVoid, void *c9_inData)
{
  ...
  real_T c9_e_u;
  const mxArray *c9_e_y = NULL;
  SFc9_Modified2InstanceStruct *chartInstance;
  chartInstance = (SFc9_Modified2InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c9_Modified2_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c9_b_is_active_c9_Modified2, const char_T *c9_identifier)
{
  ...
  c9_y = c9_o_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c9_b_is_active_c9_Modified2), &c9_thisId);
  sf_mex_destroy(&c9_b_is_active_c9_Modified2);
  return c9_y;
}
...
void sf_c9_Modified2_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c9_Modified2_get_post_codegen_info(void);
mxArray *sf_c9_Modified2_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c9_Modified2_get_post_codegen_info();
...
mxArray *sf_c9_Modified2_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c9_Modified2_jit_fallback_info(void)
{
...
mxArray *sf_c9_Modified2_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c9_Modified2(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[7],T\"F_d4\",},{M[8],M[0],T\"is_active_c9_Modified2\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c9_Modified2_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc9_Modified2InstanceStruct *) chartInfo->chartInstance;
...
static void sf_opaque_initialize_c9_Modified2(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc9_Modified2InstanceStruct*) chartInstanceVar
    )->S,0);
  initialize_params_c9_Modified2((SFc9_Modified2InstanceStruct*)
    chartInstanceVar);
  initialize_c9_Modified2((SFc9_Modified2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c9_Modified2(void *chartInstanceVar)
{
  enable_c9_Modified2((SFc9_Modified2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c9_Modified2(void *chartInstanceVar)
{
  disable_c9_Modified2((SFc9_Modified2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c9_Modified2(void *chartInstanceVar)
{
  sf_gateway_c9_Modified2((SFc9_Modified2InstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c9_Modified2(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c9_Modified2((SFc9_Modified2InstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c9_Modified2(SimStruct* S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c9_Modified2((SFc9_Modified2InstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c9_Modified2(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc9_Modified2InstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c9_Modified2((SFc9_Modified2InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc9_Modified2((SFc9_Modified2InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c9_Modified2(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c9_Modified2(SimStruct *S)
{
...
static void mdlRTW_c9_Modified2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c9_Modified2(SimStruct *S)
{
  SFc9_Modified2InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc9_Modified2InstanceStruct *)utMalloc(sizeof
    (SFc9_Modified2InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc9_Modified2InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c9_Modified2;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c9_Modified2;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c9_Modified2;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c9_Modified2;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c9_Modified2;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c9_Modified2;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c9_Modified2;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c9_Modified2;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c9_Modified2;
  chartInstance->chartInfo.mdlStart = mdlStart_c9_Modified2;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c9_Modified2;
...
void c9_Modified2_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c9_Modified2(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c9_Modified2(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c9_Modified2(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c9_Modified2_method_dispatcher.\n"
