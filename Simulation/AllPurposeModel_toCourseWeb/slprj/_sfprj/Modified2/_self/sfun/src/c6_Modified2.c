...
static void initialize_c6_Modified2(SFc6_Modified2InstanceStruct *chartInstance);
static void initialize_params_c6_Modified2(SFc6_Modified2InstanceStruct
  *chartInstance);
static void enable_c6_Modified2(SFc6_Modified2InstanceStruct *chartInstance);
static void disable_c6_Modified2(SFc6_Modified2InstanceStruct *chartInstance);
static void c6_update_debugger_state_c6_Modified2(SFc6_Modified2InstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c6_Modified2(SFc6_Modified2InstanceStruct
  *chartInstance);
static void set_sim_state_c6_Modified2(SFc6_Modified2InstanceStruct
  *chartInstance, const mxArray *c6_st);
static void finalize_c6_Modified2(SFc6_Modified2InstanceStruct *chartInstance);
static void sf_gateway_c6_Modified2(SFc6_Modified2InstanceStruct *chartInstance);
static void mdl_start_c6_Modified2(SFc6_Modified2InstanceStruct *chartInstance);
static void initSimStructsc6_Modified2(SFc6_Modified2InstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c6_machineNumber, uint32_T
  c6_chartNumber, uint32_T c6_instanceNumber);
static const mxArray *c6_sf_marshallOut(void *chartInstanceVoid, void *c6_inData);
static c6_whl_vec4 c6_emlrt_marshallIn(SFc6_Modified2InstanceStruct
  *chartInstance, const mxArray *c6_b_derF_xyw4, const char_T *c6_identifier);
static c6_whl_vec4 c6_b_emlrt_marshallIn(SFc6_Modified2InstanceStruct
  *chartInstance, const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static real_T c6_c_emlrt_marshallIn(SFc6_Modified2InstanceStruct *chartInstance,
  const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static void c6_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData);
static const mxArray *c6_b_sf_marshallOut(void *chartInstanceVoid, void
  *c6_inData);
static void c6_d_emlrt_marshallIn(SFc6_Modified2InstanceStruct *chartInstance,
  const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId,
  c6_struct_iBlsPBO3AGnt69vDoTx5zD *c6_y);
static void c6_e_emlrt_marshallIn(SFc6_Modified2InstanceStruct *chartInstance,
  const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId,
  c6_struct_Nst2vGTExxHsg85EUOj9EH *c6_y);
static c6_struct_HhckT6rntEraqECYVIDvCC c6_f_emlrt_marshallIn
  (SFc6_Modified2InstanceStruct *chartInstance, const mxArray *c6_u, const
   emlrtMsgIdentifier *c6_parentId);
static void c6_g_emlrt_marshallIn(SFc6_Modified2InstanceStruct *chartInstance,
  const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId,
  c6_struct_ZCmOWPuqBDw16FSOVVD00 *c6_y);
static void c6_h_emlrt_marshallIn(SFc6_Modified2InstanceStruct *chartInstance,
  const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId, real_T c6_y[4]);
static void c6_i_emlrt_marshallIn(SFc6_Modified2InstanceStruct *chartInstance,
  const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId,
  c6_struct_ZKAzdrl7umDGJoC14aoVKC *c6_y);
static void c6_j_emlrt_marshallIn(SFc6_Modified2InstanceStruct *chartInstance,
...
static const mxArray *c6_d_sf_marshallOut(void *chartInstanceVoid, void
  *c6_inData);
static int32_T c6_m_emlrt_marshallIn(SFc6_Modified2InstanceStruct *chartInstance,
  const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static void c6_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData);
static const mxArray *c6_w_4_bus_io(void *chartInstanceVoid, void *c6_pData);
static uint8_T c6_n_emlrt_marshallIn(SFc6_Modified2InstanceStruct *chartInstance,
  const mxArray *c6_b_is_active_c6_Modified2, const char_T *c6_identifier);
static uint8_T c6_o_emlrt_marshallIn(SFc6_Modified2InstanceStruct *chartInstance,
  const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static void init_dsm_address_info(SFc6_Modified2InstanceStruct *chartInstance);
static void init_simulink_io_address(SFc6_Modified2InstanceStruct *chartInstance);
...
static void initialize_c6_Modified2(SFc6_Modified2InstanceStruct *chartInstance)
{
  ...
  chartInstance->c6_is_active_c6_Modified2 = 0U;
}
  ...
  *chartInstance)
{
  ...
  c6_hoistedGlobal = chartInstance->c6_is_active_c6_Modified2;
  ...
  *chartInstance, const mxArray *c6_st)
{
  ...
  *(real_T *)&((char_T *)chartInstance->c6_derF_xyw4)[24] = c6_r1.rr;
  chartInstance->c6_is_active_c6_Modified2 = c6_n_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c6_u, 1)), "is_active_c6_Modified2");
  sf_mex_destroy(&c6_u);
  c6_update_debugger_state_c6_Modified2(chartInstance);
...
static const mxArray *c6_sf_marshallOut(void *chartInstanceVoid, void *c6_inData)
{
  ...
  real_T c6_e_u;
  const mxArray *c6_e_y = NULL;
  SFc6_Modified2InstanceStruct *chartInstance;
  chartInstance = (SFc6_Modified2InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c6_Modified2_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c6_b_is_active_c6_Modified2, const char_T *c6_identifier)
{
  ...
  c6_y = c6_o_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c6_b_is_active_c6_Modified2), &c6_thisId);
  sf_mex_destroy(&c6_b_is_active_c6_Modified2);
  return c6_y;
}
...
void sf_c6_Modified2_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c6_Modified2_get_post_codegen_info(void);
mxArray *sf_c6_Modified2_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c6_Modified2_get_post_codegen_info();
...
mxArray *sf_c6_Modified2_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c6_Modified2_jit_fallback_info(void)
{
...
mxArray *sf_c6_Modified2_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c6_Modified2(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[7],T\"derF_xyw4\",},{M[8],M[0],T\"is_active_c6_Modified2\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c6_Modified2_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc6_Modified2InstanceStruct *) chartInfo->chartInstance;
...
static void sf_opaque_initialize_c6_Modified2(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc6_Modified2InstanceStruct*) chartInstanceVar
    )->S,0);
  initialize_params_c6_Modified2((SFc6_Modified2InstanceStruct*)
    chartInstanceVar);
  initialize_c6_Modified2((SFc6_Modified2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c6_Modified2(void *chartInstanceVar)
{
  enable_c6_Modified2((SFc6_Modified2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c6_Modified2(void *chartInstanceVar)
{
  disable_c6_Modified2((SFc6_Modified2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c6_Modified2(void *chartInstanceVar)
{
  sf_gateway_c6_Modified2((SFc6_Modified2InstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c6_Modified2(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c6_Modified2((SFc6_Modified2InstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c6_Modified2(SimStruct* S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c6_Modified2((SFc6_Modified2InstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c6_Modified2(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc6_Modified2InstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c6_Modified2((SFc6_Modified2InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc6_Modified2((SFc6_Modified2InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c6_Modified2(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c6_Modified2(SimStruct *S)
{
...
static void mdlRTW_c6_Modified2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c6_Modified2(SimStruct *S)
{
  SFc6_Modified2InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc6_Modified2InstanceStruct *)utMalloc(sizeof
    (SFc6_Modified2InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc6_Modified2InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c6_Modified2;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c6_Modified2;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c6_Modified2;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c6_Modified2;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c6_Modified2;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c6_Modified2;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c6_Modified2;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c6_Modified2;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c6_Modified2;
  chartInstance->chartInfo.mdlStart = mdlStart_c6_Modified2;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c6_Modified2;
...
void c6_Modified2_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c6_Modified2(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c6_Modified2(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c6_Modified2(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c6_Modified2_method_dispatcher.\n"
