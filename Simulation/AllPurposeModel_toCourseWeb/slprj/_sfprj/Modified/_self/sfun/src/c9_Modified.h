#ifndef __c9_Modified_h__
#define __c9_Modified_h__
...
#ifndef typedef_SFc9_ModifiedInstanceStruct
#define typedef_SFc9_ModifiedInstanceStruct
...
typedef struct {
  ...
  uint8_T c9_is_active_c9_Modified;
  c9_struct_iBlsPBO3AGnt69vDoTx5zD c9_Par;
  c9_whl_vec4 *c9_v_z4;
  c9_whl_vec4 *c9_F_d4;
} SFc9_ModifiedInstanceStruct;

#endif                                 /*typedef_SFc9_ModifiedInstanceStruct*/
...
extern const mxArray *sf_c9_Modified_get_eml_resolved_functions_info(void);

/* Function Definitions */
extern void sf_c9_Modified_get_check_sum(mxArray *plhs[]);
extern void c9_Modified_method_dispatcher(SimStruct *S, int_T method, void *data);
