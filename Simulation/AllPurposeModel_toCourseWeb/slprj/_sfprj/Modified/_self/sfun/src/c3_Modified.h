#ifndef __c3_Modified_h__
#define __c3_Modified_h__
...
#ifndef typedef_SFc3_ModifiedInstanceStruct
#define typedef_SFc3_ModifiedInstanceStruct
...
typedef struct {
  ...
  uint8_T c3_is_active_c3_Modified;
...
#endif                                 /*typedef_SFc3_ModifiedInstanceStruct*/
...
extern const mxArray *sf_c3_Modified_get_eml_resolved_functions_info(void);

/* Function Definitions */
extern void sf_c3_Modified_get_check_sum(mxArray *plhs[]);
extern void c3_Modified_method_dispatcher(SimStruct *S, int_T method, void *data);
