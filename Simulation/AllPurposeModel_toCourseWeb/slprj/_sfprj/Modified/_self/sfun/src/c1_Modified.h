#ifndef __c1_Modified_h__
#define __c1_Modified_h__
...
#ifndef typedef_c1_whl_vec4
#define typedef_c1_whl_vec4

typedef struct whl_vec4_tag c1_whl_vec4;

#endif                                 /*typedef_c1_whl_vec4*/
...
#ifndef typedef_SFc1_ModifiedInstanceStruct
#define typedef_SFc1_ModifiedInstanceStruct
...
typedef struct {
  ...
  uint8_T c1_is_active_c1_Modified;
  c1_struct_iBlsPBO3AGnt69vDoTx5zD c1_Par;
  c1_whl_vec4 *c1_T_s4;
  c1_whl_vec4 *c1_T_us4;
  real_T *c1_APed;
  real_T *c1_BPed;
  real_T *c1_SteWhlAn;
  real_T *c1_LongDir;
  c1_whl_vec4 *c1_w_w4_actl;
  c1_whl_vec4 *c1_delta_w4;
} SFc1_ModifiedInstanceStruct;

#endif                                 /*typedef_SFc1_ModifiedInstanceStruct*/
...
extern const mxArray *sf_c1_Modified_get_eml_resolved_functions_info(void);

/* Function Definitions */
extern void sf_c1_Modified_get_check_sum(mxArray *plhs[]);
extern void c1_Modified_method_dispatcher(SimStruct *S, int_T method, void *data);
