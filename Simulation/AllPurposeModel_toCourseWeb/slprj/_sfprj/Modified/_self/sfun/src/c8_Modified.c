...
static void initialize_c8_Modified(SFc8_ModifiedInstanceStruct *chartInstance);
static void initialize_params_c8_Modified(SFc8_ModifiedInstanceStruct
  *chartInstance);
static void enable_c8_Modified(SFc8_ModifiedInstanceStruct *chartInstance);
static void disable_c8_Modified(SFc8_ModifiedInstanceStruct *chartInstance);
static void c8_update_debugger_state_c8_Modified(SFc8_ModifiedInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c8_Modified(SFc8_ModifiedInstanceStruct
  *chartInstance);
static void set_sim_state_c8_Modified(SFc8_ModifiedInstanceStruct *chartInstance,
  const mxArray *c8_st);
static void finalize_c8_Modified(SFc8_ModifiedInstanceStruct *chartInstance);
static void sf_gateway_c8_Modified(SFc8_ModifiedInstanceStruct *chartInstance);
static void mdl_start_c8_Modified(SFc8_ModifiedInstanceStruct *chartInstance);
static void initSimStructsc8_Modified(SFc8_ModifiedInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c8_machineNumber, uint32_T
  c8_chartNumber, uint32_T c8_instanceNumber);
static const mxArray *c8_sf_marshallOut(void *chartInstanceVoid, void *c8_inData);
static c8_irp_vec3 c8_emlrt_marshallIn(SFc8_ModifiedInstanceStruct
  *chartInstance, const mxArray *c8_b_derpos_irp3, const char_T *c8_identifier);
static c8_irp_vec3 c8_b_emlrt_marshallIn(SFc8_ModifiedInstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static real_T c8_c_emlrt_marshallIn(SFc8_ModifiedInstanceStruct *chartInstance,
...
static const mxArray *c8_c_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static int32_T c8_d_emlrt_marshallIn(SFc8_ModifiedInstanceStruct *chartInstance,
  const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void c8_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData);
static const mxArray *c8_v_irp3_bus_io(void *chartInstanceVoid, void *c8_pData);
static uint8_T c8_e_emlrt_marshallIn(SFc8_ModifiedInstanceStruct *chartInstance,
  const mxArray *c8_b_is_active_c8_Modified, const char_T *c8_identifier);
static uint8_T c8_f_emlrt_marshallIn(SFc8_ModifiedInstanceStruct *chartInstance,
  const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void init_dsm_address_info(SFc8_ModifiedInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc8_ModifiedInstanceStruct *chartInstance);
...
static void initialize_c8_Modified(SFc8_ModifiedInstanceStruct *chartInstance)
{
  ...
  chartInstance->c8_is_active_c8_Modified = 0U;
}
  ...
  *chartInstance)
{
  ...
  c8_hoistedGlobal = chartInstance->c8_is_active_c8_Modified;
  ...
  const mxArray *c8_st)
{
  ...
  *(real_T *)&((char_T *)chartInstance->c8_derpos_irp3)[16] = c8_r0.rotz;
  chartInstance->c8_is_active_c8_Modified = c8_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c8_u, 1)), "is_active_c8_Modified");
  sf_mex_destroy(&c8_u);
  c8_update_debugger_state_c8_Modified(chartInstance);
...
static const mxArray *c8_sf_marshallOut(void *chartInstanceVoid, void *c8_inData)
{
  ...
  real_T c8_d_u;
  const mxArray *c8_d_y = NULL;
  SFc8_ModifiedInstanceStruct *chartInstance;
  chartInstance = (SFc8_ModifiedInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c8_Modified_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c8_b_is_active_c8_Modified, const char_T *c8_identifier)
{
  ...
  c8_y = c8_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c8_b_is_active_c8_Modified), &c8_thisId);
  sf_mex_destroy(&c8_b_is_active_c8_Modified);
  return c8_y;
}
...
void sf_c8_Modified_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1540570839U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(111901953U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1678914824U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2481076241U);
}

mxArray* sf_c8_Modified_get_post_codegen_info(void);
mxArray *sf_c8_Modified_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c8_Modified_get_post_codegen_info();
...
mxArray *sf_c8_Modified_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c8_Modified_jit_fallback_info(void)
{
...
mxArray *sf_c8_Modified_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c8_Modified(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[10],T\"derpos_irp3\",},{M[8],M[0],T\"is_active_c8_Modified\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c8_Modified_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc8_ModifiedInstanceStruct *) chartInfo->chartInstance;
...
{
  return "8fQ2H75RPTLe6rKwfwEDHB";
}

static void sf_opaque_initialize_c8_Modified(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc8_ModifiedInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c8_Modified((SFc8_ModifiedInstanceStruct*) chartInstanceVar);
  initialize_c8_Modified((SFc8_ModifiedInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c8_Modified(void *chartInstanceVar)
{
  enable_c8_Modified((SFc8_ModifiedInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c8_Modified(void *chartInstanceVar)
{
  disable_c8_Modified((SFc8_ModifiedInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c8_Modified(void *chartInstanceVar)
{
  sf_gateway_c8_Modified((SFc8_ModifiedInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c8_Modified(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c8_Modified((SFc8_ModifiedInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c8_Modified(SimStruct* S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c8_Modified((SFc8_ModifiedInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c8_Modified(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc8_ModifiedInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c8_Modified((SFc8_ModifiedInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc8_Modified((SFc8_ModifiedInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c8_Modified(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c8_Modified((SFc8_ModifiedInstanceStruct*)
      (chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c8_Modified(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(2300729146U));
  ssSetChecksum1(S,(2685000111U));
  ssSetChecksum2(S,(562163787U));
  ssSetChecksum3(S,(431930761U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c8_Modified(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c8_Modified(SimStruct *S)
{
  SFc8_ModifiedInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc8_ModifiedInstanceStruct *)utMalloc(sizeof
    (SFc8_ModifiedInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc8_ModifiedInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c8_Modified;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c8_Modified;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c8_Modified;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c8_Modified;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c8_Modified;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c8_Modified;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c8_Modified;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c8_Modified;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c8_Modified;
  chartInstance->chartInfo.mdlStart = mdlStart_c8_Modified;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c8_Modified;
...
void c8_Modified_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c8_Modified(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c8_Modified(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c8_Modified(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c8_Modified_method_dispatcher.\n"
