#ifndef __c20_Modified_h__
#define __c20_Modified_h__
...
#ifndef typedef_SFc20_ModifiedInstanceStruct
#define typedef_SFc20_ModifiedInstanceStruct
...
typedef struct {
  ...
  uint8_T c20_is_active_c20_Modified;
...
#endif                                 /*typedef_SFc20_ModifiedInstanceStruct*/
...
extern const mxArray *sf_c20_Modified_get_eml_resolved_functions_info(void);

/* Function Definitions */
extern void sf_c20_Modified_get_check_sum(mxArray *plhs[]);
extern void c20_Modified_method_dispatcher(SimStruct *S, int_T method, void
  *data);
