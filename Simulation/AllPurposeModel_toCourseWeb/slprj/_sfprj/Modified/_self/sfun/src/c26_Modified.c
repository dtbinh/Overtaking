...
static void initialize_c26_Modified(SFc26_ModifiedInstanceStruct *chartInstance);
static void initialize_params_c26_Modified(SFc26_ModifiedInstanceStruct
  *chartInstance);
static void enable_c26_Modified(SFc26_ModifiedInstanceStruct *chartInstance);
static void disable_c26_Modified(SFc26_ModifiedInstanceStruct *chartInstance);
static void c26_update_debugger_state_c26_Modified(SFc26_ModifiedInstanceStruct *
  chartInstance);
static const mxArray *get_sim_state_c26_Modified(SFc26_ModifiedInstanceStruct
  *chartInstance);
static void set_sim_state_c26_Modified(SFc26_ModifiedInstanceStruct
  *chartInstance, const mxArray *c26_st);
static void finalize_c26_Modified(SFc26_ModifiedInstanceStruct *chartInstance);
static void sf_gateway_c26_Modified(SFc26_ModifiedInstanceStruct *chartInstance);
static void mdl_start_c26_Modified(SFc26_ModifiedInstanceStruct *chartInstance);
static void initSimStructsc26_Modified(SFc26_ModifiedInstanceStruct
  *chartInstance);
...
static const mxArray *c26_sf_marshallOut(void *chartInstanceVoid, void
  *c26_inData);
static c26_whl_vec4 c26_emlrt_marshallIn(SFc26_ModifiedInstanceStruct
  *chartInstance, const mxArray *c26_b_derw_w4, const char_T *c26_identifier);
static c26_whl_vec4 c26_b_emlrt_marshallIn(SFc26_ModifiedInstanceStruct
  *chartInstance, const mxArray *c26_u, const emlrtMsgIdentifier *c26_parentId);
static real_T c26_c_emlrt_marshallIn(SFc26_ModifiedInstanceStruct *chartInstance,
...
static const mxArray *c26_b_sf_marshallOut(void *chartInstanceVoid, void
  *c26_inData);
static void c26_d_emlrt_marshallIn(SFc26_ModifiedInstanceStruct *chartInstance,
  const mxArray *c26_u, const emlrtMsgIdentifier *c26_parentId,
  c26_struct_iBlsPBO3AGnt69vDoTx5zD *c26_y);
static void c26_e_emlrt_marshallIn(SFc26_ModifiedInstanceStruct *chartInstance,
  const mxArray *c26_u, const emlrtMsgIdentifier *c26_parentId,
  c26_struct_Nst2vGTExxHsg85EUOj9EH *c26_y);
static c26_struct_HhckT6rntEraqECYVIDvCC c26_f_emlrt_marshallIn
  (SFc26_ModifiedInstanceStruct *chartInstance, const mxArray *c26_u, const
   emlrtMsgIdentifier *c26_parentId);
static void c26_g_emlrt_marshallIn(SFc26_ModifiedInstanceStruct *chartInstance,
  const mxArray *c26_u, const emlrtMsgIdentifier *c26_parentId,
  c26_struct_ZCmOWPuqBDw16FSOVVD00 *c26_y);
static void c26_h_emlrt_marshallIn(SFc26_ModifiedInstanceStruct *chartInstance,
  const mxArray *c26_u, const emlrtMsgIdentifier *c26_parentId, real_T c26_y[4]);
static void c26_i_emlrt_marshallIn(SFc26_ModifiedInstanceStruct *chartInstance,
  const mxArray *c26_u, const emlrtMsgIdentifier *c26_parentId,
  c26_struct_ZKAzdrl7umDGJoC14aoVKC *c26_y);
static void c26_j_emlrt_marshallIn(SFc26_ModifiedInstanceStruct *chartInstance,
...
static const mxArray *c26_d_sf_marshallOut(void *chartInstanceVoid, void
  *c26_inData);
static int32_T c26_m_emlrt_marshallIn(SFc26_ModifiedInstanceStruct
  *chartInstance, const mxArray *c26_u, const emlrtMsgIdentifier *c26_parentId);
...
static uint8_T c26_n_emlrt_marshallIn(SFc26_ModifiedInstanceStruct
  *chartInstance, const mxArray *c26_b_is_active_c26_Modified, const char_T
  *c26_identifier);
static uint8_T c26_o_emlrt_marshallIn(SFc26_ModifiedInstanceStruct
  *chartInstance, const mxArray *c26_u, const emlrtMsgIdentifier *c26_parentId);
static void init_dsm_address_info(SFc26_ModifiedInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc26_ModifiedInstanceStruct *chartInstance);
...
static void initialize_c26_Modified(SFc26_ModifiedInstanceStruct *chartInstance)
{
  ...
  chartInstance->c26_is_active_c26_Modified = 0U;
}
  ...
  *chartInstance)
{
  ...
  c26_hoistedGlobal = chartInstance->c26_is_active_c26_Modified;
  ...
  *chartInstance, const mxArray *c26_st)
{
  ...
  *(real_T *)&((char_T *)chartInstance->c26_derw_w4)[24] = c26_r1.rr;
  chartInstance->c26_is_active_c26_Modified = c26_n_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c26_u, 1)),
     "is_active_c26_Modified");
  sf_mex_destroy(&c26_u);
  c26_update_debugger_state_c26_Modified(chartInstance);
  ...
  *c26_inData)
{
  ...
  real_T c26_e_u;
  const mxArray *c26_e_y = NULL;
  SFc26_ModifiedInstanceStruct *chartInstance;
  chartInstance = (SFc26_ModifiedInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c26_Modified_get_eml_resolved_functions_info(void)
{
  ...
  *c26_identifier)
{
  ...
  c26_y = c26_o_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c26_b_is_active_c26_Modified), &c26_thisId);
  sf_mex_destroy(&c26_b_is_active_c26_Modified);
  return c26_y;
}
...
void sf_c26_Modified_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(4230518743U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3345744565U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(523165330U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(171799543U);
}

mxArray* sf_c26_Modified_get_post_codegen_info(void);
mxArray *sf_c26_Modified_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c26_Modified_get_post_codegen_info();
...
mxArray *sf_c26_Modified_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c26_Modified_jit_fallback_info(void)
{
...
mxArray *sf_c26_Modified_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c26_Modified(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[7],T\"derw_w4\",},{M[8],M[0],T\"is_active_c26_Modified\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c26_Modified_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc26_ModifiedInstanceStruct *) chartInfo->chartInstance;
...
{
  return "wK9c01wzINN1qNhLc8z6SB";
}

static void sf_opaque_initialize_c26_Modified(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc26_ModifiedInstanceStruct*) chartInstanceVar
    )->S,0);
  initialize_params_c26_Modified((SFc26_ModifiedInstanceStruct*)
    chartInstanceVar);
  initialize_c26_Modified((SFc26_ModifiedInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c26_Modified(void *chartInstanceVar)
{
  enable_c26_Modified((SFc26_ModifiedInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c26_Modified(void *chartInstanceVar)
{
  disable_c26_Modified((SFc26_ModifiedInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c26_Modified(void *chartInstanceVar)
{
  sf_gateway_c26_Modified((SFc26_ModifiedInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c26_Modified(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c26_Modified((SFc26_ModifiedInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c26_Modified(SimStruct* S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c26_Modified((SFc26_ModifiedInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c26_Modified(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc26_ModifiedInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c26_Modified((SFc26_ModifiedInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc26_Modified((SFc26_ModifiedInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c26_Modified(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c26_Modified(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(534491447U));
  ssSetChecksum1(S,(1470760239U));
  ssSetChecksum2(S,(2657701538U));
  ssSetChecksum3(S,(1306201500U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c26_Modified(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c26_Modified(SimStruct *S)
{
  SFc26_ModifiedInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc26_ModifiedInstanceStruct *)utMalloc(sizeof
    (SFc26_ModifiedInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc26_ModifiedInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c26_Modified;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c26_Modified;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c26_Modified;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c26_Modified;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c26_Modified;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c26_Modified;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c26_Modified;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c26_Modified;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c26_Modified;
  chartInstance->chartInfo.mdlStart = mdlStart_c26_Modified;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c26_Modified;
...
void c26_Modified_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c26_Modified(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c26_Modified(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c26_Modified(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c26_Modified_method_dispatcher.\n"
