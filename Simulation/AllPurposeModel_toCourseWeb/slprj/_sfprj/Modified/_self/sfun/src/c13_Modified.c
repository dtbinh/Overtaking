...
static void initialize_c13_Modified(SFc13_ModifiedInstanceStruct *chartInstance);
static void initialize_params_c13_Modified(SFc13_ModifiedInstanceStruct
  *chartInstance);
static void enable_c13_Modified(SFc13_ModifiedInstanceStruct *chartInstance);
static void disable_c13_Modified(SFc13_ModifiedInstanceStruct *chartInstance);
static void c13_update_debugger_state_c13_Modified(SFc13_ModifiedInstanceStruct *
  chartInstance);
static const mxArray *get_sim_state_c13_Modified(SFc13_ModifiedInstanceStruct
  *chartInstance);
static void set_sim_state_c13_Modified(SFc13_ModifiedInstanceStruct
  *chartInstance, const mxArray *c13_st);
static void finalize_c13_Modified(SFc13_ModifiedInstanceStruct *chartInstance);
static void sf_gateway_c13_Modified(SFc13_ModifiedInstanceStruct *chartInstance);
static void mdl_start_c13_Modified(SFc13_ModifiedInstanceStruct *chartInstance);
static void initSimStructsc13_Modified(SFc13_ModifiedInstanceStruct
  *chartInstance);
...
static const mxArray *c13_sf_marshallOut(void *chartInstanceVoid, void
  *c13_inData);
static c13_whl_vec4 c13_emlrt_marshallIn(SFc13_ModifiedInstanceStruct
  *chartInstance, const mxArray *c13_b_v_z4, const char_T *c13_identifier);
static c13_whl_vec4 c13_b_emlrt_marshallIn(SFc13_ModifiedInstanceStruct
  *chartInstance, const mxArray *c13_u, const emlrtMsgIdentifier *c13_parentId);
static real_T c13_c_emlrt_marshallIn(SFc13_ModifiedInstanceStruct *chartInstance,
...
static const mxArray *c13_b_sf_marshallOut(void *chartInstanceVoid, void
  *c13_inData);
static void c13_d_emlrt_marshallIn(SFc13_ModifiedInstanceStruct *chartInstance,
  const mxArray *c13_u, const emlrtMsgIdentifier *c13_parentId,
  c13_struct_iBlsPBO3AGnt69vDoTx5zD *c13_y);
static void c13_e_emlrt_marshallIn(SFc13_ModifiedInstanceStruct *chartInstance,
  const mxArray *c13_u, const emlrtMsgIdentifier *c13_parentId,
  c13_struct_Nst2vGTExxHsg85EUOj9EH *c13_y);
static c13_struct_HhckT6rntEraqECYVIDvCC c13_f_emlrt_marshallIn
  (SFc13_ModifiedInstanceStruct *chartInstance, const mxArray *c13_u, const
   emlrtMsgIdentifier *c13_parentId);
static void c13_g_emlrt_marshallIn(SFc13_ModifiedInstanceStruct *chartInstance,
  const mxArray *c13_u, const emlrtMsgIdentifier *c13_parentId,
  c13_struct_ZCmOWPuqBDw16FSOVVD00 *c13_y);
static void c13_h_emlrt_marshallIn(SFc13_ModifiedInstanceStruct *chartInstance,
  const mxArray *c13_u, const emlrtMsgIdentifier *c13_parentId, real_T c13_y[4]);
static void c13_i_emlrt_marshallIn(SFc13_ModifiedInstanceStruct *chartInstance,
  const mxArray *c13_u, const emlrtMsgIdentifier *c13_parentId,
  c13_struct_ZKAzdrl7umDGJoC14aoVKC *c13_y);
static void c13_j_emlrt_marshallIn(SFc13_ModifiedInstanceStruct *chartInstance,
...
static const mxArray *c13_e_sf_marshallOut(void *chartInstanceVoid, void
  *c13_inData);
static void c13_m_emlrt_marshallIn(SFc13_ModifiedInstanceStruct *chartInstance,
  const mxArray *c13_u, const emlrtMsgIdentifier *c13_parentId, real_T c13_y[4]);
...
static const mxArray *c13_f_sf_marshallOut(void *chartInstanceVoid, void
  *c13_inData);
static void c13_n_emlrt_marshallIn(SFc13_ModifiedInstanceStruct *chartInstance,
  const mxArray *c13_u, const emlrtMsgIdentifier *c13_parentId, real_T c13_y[3]);
...
static void c13_eml_scalar_eg(SFc13_ModifiedInstanceStruct *chartInstance);
static void c13_eml_xgemm(SFc13_ModifiedInstanceStruct *chartInstance, real_T
...
static const mxArray *c13_g_sf_marshallOut(void *chartInstanceVoid, void
  *c13_inData);
static int32_T c13_o_emlrt_marshallIn(SFc13_ModifiedInstanceStruct
  *chartInstance, const mxArray *c13_u, const emlrtMsgIdentifier *c13_parentId);
...
static uint8_T c13_p_emlrt_marshallIn(SFc13_ModifiedInstanceStruct
  *chartInstance, const mxArray *c13_b_is_active_c13_Modified, const char_T
  *c13_identifier);
static uint8_T c13_q_emlrt_marshallIn(SFc13_ModifiedInstanceStruct
  *chartInstance, const mxArray *c13_u, const emlrtMsgIdentifier *c13_parentId);
static void c13_b_eml_xgemm(SFc13_ModifiedInstanceStruct *chartInstance, real_T
  c13_A[12], real_T c13_B[3], real_T c13_C[4]);
static void init_dsm_address_info(SFc13_ModifiedInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc13_ModifiedInstanceStruct *chartInstance);
...
static void initialize_c13_Modified(SFc13_ModifiedInstanceStruct *chartInstance)
{
  ...
  chartInstance->c13_is_active_c13_Modified = 0U;
}
  ...
  *chartInstance)
{
  ...
  c13_hoistedGlobal = chartInstance->c13_is_active_c13_Modified;
  ...
  *chartInstance, const mxArray *c13_st)
{
  ...
  *(real_T *)&((char_T *)chartInstance->c13_v_z4)[24] = c13_r1.rr;
  chartInstance->c13_is_active_c13_Modified = c13_p_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c13_u, 1)),
     "is_active_c13_Modified");
  sf_mex_destroy(&c13_u);
  c13_update_debugger_state_c13_Modified(chartInstance);
  ...
  *c13_inData)
{
  ...
  real_T c13_e_u;
  const mxArray *c13_e_y = NULL;
  SFc13_ModifiedInstanceStruct *chartInstance;
  chartInstance = (SFc13_ModifiedInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c13_Modified_get_eml_resolved_functions_info(void)
{
  ...
  *c13_identifier)
{
  ...
  c13_y = c13_q_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c13_b_is_active_c13_Modified), &c13_thisId);
  sf_mex_destroy(&c13_b_is_active_c13_Modified);
  return c13_y;
}
...
void sf_c13_Modified_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c13_Modified_get_post_codegen_info(void);
mxArray *sf_c13_Modified_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c13_Modified_get_post_codegen_info();
...
mxArray *sf_c13_Modified_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c13_Modified_jit_fallback_info(void)
{
...
mxArray *sf_c13_Modified_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c13_Modified(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"v_z4\",},{M[8],M[0],T\"is_active_c13_Modified\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c13_Modified_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc13_ModifiedInstanceStruct *) chartInfo->chartInstance;
...
static void sf_opaque_initialize_c13_Modified(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc13_ModifiedInstanceStruct*) chartInstanceVar
    )->S,0);
  initialize_params_c13_Modified((SFc13_ModifiedInstanceStruct*)
    chartInstanceVar);
  initialize_c13_Modified((SFc13_ModifiedInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c13_Modified(void *chartInstanceVar)
{
  enable_c13_Modified((SFc13_ModifiedInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c13_Modified(void *chartInstanceVar)
{
  disable_c13_Modified((SFc13_ModifiedInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c13_Modified(void *chartInstanceVar)
{
  sf_gateway_c13_Modified((SFc13_ModifiedInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c13_Modified(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c13_Modified((SFc13_ModifiedInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c13_Modified(SimStruct* S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c13_Modified((SFc13_ModifiedInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c13_Modified(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc13_ModifiedInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c13_Modified((SFc13_ModifiedInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc13_Modified((SFc13_ModifiedInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c13_Modified(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c13_Modified(SimStruct *S)
{
...
static void mdlRTW_c13_Modified(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c13_Modified(SimStruct *S)
{
  SFc13_ModifiedInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc13_ModifiedInstanceStruct *)utMalloc(sizeof
    (SFc13_ModifiedInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc13_ModifiedInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c13_Modified;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c13_Modified;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c13_Modified;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c13_Modified;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c13_Modified;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c13_Modified;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c13_Modified;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c13_Modified;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c13_Modified;
  chartInstance->chartInfo.mdlStart = mdlStart_c13_Modified;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c13_Modified;
...
void c13_Modified_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c13_Modified(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c13_Modified(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c13_Modified(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c13_Modified_method_dispatcher.\n"
