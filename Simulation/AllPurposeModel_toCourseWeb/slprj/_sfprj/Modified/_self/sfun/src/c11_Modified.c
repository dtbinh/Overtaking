...
static void initialize_c11_Modified(SFc11_ModifiedInstanceStruct *chartInstance);
static void initialize_params_c11_Modified(SFc11_ModifiedInstanceStruct
  *chartInstance);
static void enable_c11_Modified(SFc11_ModifiedInstanceStruct *chartInstance);
static void disable_c11_Modified(SFc11_ModifiedInstanceStruct *chartInstance);
static void c11_update_debugger_state_c11_Modified(SFc11_ModifiedInstanceStruct *
  chartInstance);
static const mxArray *get_sim_state_c11_Modified(SFc11_ModifiedInstanceStruct
  *chartInstance);
static void set_sim_state_c11_Modified(SFc11_ModifiedInstanceStruct
  *chartInstance, const mxArray *c11_st);
static void finalize_c11_Modified(SFc11_ModifiedInstanceStruct *chartInstance);
static void sf_gateway_c11_Modified(SFc11_ModifiedInstanceStruct *chartInstance);
static void mdl_start_c11_Modified(SFc11_ModifiedInstanceStruct *chartInstance);
static void c11_chartstep_c11_Modified(SFc11_ModifiedInstanceStruct
  *chartInstance);
static void initSimStructsc11_Modified(SFc11_ModifiedInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c11_machineNumber, uint32_T
  c11_chartNumber, uint32_T c11_instanceNumber);
static const mxArray *c11_sf_marshallOut(void *chartInstanceVoid, void
  *c11_inData);
static c11_oorp_vec3 c11_emlrt_marshallIn(SFc11_ModifiedInstanceStruct
  *chartInstance, const mxArray *c11_b_derv_oorp3, const char_T *c11_identifier);
static c11_oorp_vec3 c11_b_emlrt_marshallIn(SFc11_ModifiedInstanceStruct
  *chartInstance, const mxArray *c11_u, const emlrtMsgIdentifier *c11_parentId);
static real_T c11_c_emlrt_marshallIn(SFc11_ModifiedInstanceStruct *chartInstance,
  const mxArray *c11_u, const emlrtMsgIdentifier *c11_parentId);
static void c11_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c11_mxArrayInData, const char_T *c11_varName, void *c11_outData);
static const mxArray *c11_b_sf_marshallOut(void *chartInstanceVoid, void
  *c11_inData);
static void c11_d_emlrt_marshallIn(SFc11_ModifiedInstanceStruct *chartInstance,
  const mxArray *c11_u, const emlrtMsgIdentifier *c11_parentId,
  c11_struct_iBlsPBO3AGnt69vDoTx5zD *c11_y);
static void c11_e_emlrt_marshallIn(SFc11_ModifiedInstanceStruct *chartInstance,
  const mxArray *c11_u, const emlrtMsgIdentifier *c11_parentId,
  c11_struct_Nst2vGTExxHsg85EUOj9EH *c11_y);
static c11_struct_HhckT6rntEraqECYVIDvCC c11_f_emlrt_marshallIn
  (SFc11_ModifiedInstanceStruct *chartInstance, const mxArray *c11_u, const
   emlrtMsgIdentifier *c11_parentId);
static void c11_g_emlrt_marshallIn(SFc11_ModifiedInstanceStruct *chartInstance,
  const mxArray *c11_u, const emlrtMsgIdentifier *c11_parentId,
  c11_struct_ZCmOWPuqBDw16FSOVVD00 *c11_y);
static void c11_h_emlrt_marshallIn(SFc11_ModifiedInstanceStruct *chartInstance,
  const mxArray *c11_u, const emlrtMsgIdentifier *c11_parentId, real_T c11_y[4]);
static void c11_i_emlrt_marshallIn(SFc11_ModifiedInstanceStruct *chartInstance,
  const mxArray *c11_u, const emlrtMsgIdentifier *c11_parentId,
  c11_struct_ZKAzdrl7umDGJoC14aoVKC *c11_y);
static void c11_j_emlrt_marshallIn(SFc11_ModifiedInstanceStruct *chartInstance,
...
static const mxArray *c11_e_sf_marshallOut(void *chartInstanceVoid, void
  *c11_inData);
static void c11_m_emlrt_marshallIn(SFc11_ModifiedInstanceStruct *chartInstance,
  const mxArray *c11_u, const emlrtMsgIdentifier *c11_parentId, real_T c11_y[3]);
...
static const mxArray *c11_f_sf_marshallOut(void *chartInstanceVoid, void
  *c11_inData);
static void c11_n_emlrt_marshallIn(SFc11_ModifiedInstanceStruct *chartInstance,
  const mxArray *c11_u, const emlrtMsgIdentifier *c11_parentId, real_T c11_y[4]);
...
static const mxArray *c11_g_sf_marshallOut(void *chartInstanceVoid, void
  *c11_inData);
static void c11_o_emlrt_marshallIn(SFc11_ModifiedInstanceStruct *chartInstance,
...
static void c11_eml_scalar_eg(SFc11_ModifiedInstanceStruct *chartInstance);
static void c11_eml_xgemm(SFc11_ModifiedInstanceStruct *chartInstance, real_T
...
static const mxArray *c11_h_sf_marshallOut(void *chartInstanceVoid, void
  *c11_inData);
static int32_T c11_p_emlrt_marshallIn(SFc11_ModifiedInstanceStruct
  *chartInstance, const mxArray *c11_u, const emlrtMsgIdentifier *c11_parentId);
...
static const mxArray *c11_derv_oorp3_bus_io(void *chartInstanceVoid, void
  *c11_pData);
static uint8_T c11_q_emlrt_marshallIn(SFc11_ModifiedInstanceStruct
  *chartInstance, const mxArray *c11_b_is_active_c11_Modified, const char_T
  *c11_identifier);
static uint8_T c11_r_emlrt_marshallIn(SFc11_ModifiedInstanceStruct
  *chartInstance, const mxArray *c11_u, const emlrtMsgIdentifier *c11_parentId);
static void c11_b_eml_xgemm(SFc11_ModifiedInstanceStruct *chartInstance, real_T
  c11_A[12], real_T c11_B[4], real_T c11_C[3]);
static void init_dsm_address_info(SFc11_ModifiedInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc11_ModifiedInstanceStruct *chartInstance);
...
static void initialize_c11_Modified(SFc11_ModifiedInstanceStruct *chartInstance)
{
  ...
  chartInstance->c11_is_active_c11_Modified = 0U;
}
  ...
  *chartInstance)
{
  ...
  c11_hoistedGlobal = chartInstance->c11_is_active_c11_Modified;
  ...
  *chartInstance, const mxArray *c11_st)
{
  ...
  *(real_T *)&((char_T *)chartInstance->c11_derv_oorp3)[16] = c11_r1.roty;
  chartInstance->c11_is_active_c11_Modified = c11_q_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c11_u, 1)),
     "is_active_c11_Modified");
  sf_mex_destroy(&c11_u);
  c11_update_debugger_state_c11_Modified(chartInstance);
...
static void sf_gateway_c11_Modified(SFc11_ModifiedInstanceStruct *chartInstance)
{
  ...
  chartInstance->c11_sfEvent = CALL_EVENT;
  c11_chartstep_c11_Modified(chartInstance);
  ...
  *c11_inData)
{
  ...
  real_T c11_d_u;
  const mxArray *c11_d_y = NULL;
  SFc11_ModifiedInstanceStruct *chartInstance;
  chartInstance = (SFc11_ModifiedInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c11_Modified_get_eml_resolved_functions_info(void)
{
  ...
  *c11_identifier)
{
  ...
  c11_y = c11_r_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c11_b_is_active_c11_Modified), &c11_thisId);
  sf_mex_destroy(&c11_b_is_active_c11_Modified);
  return c11_y;
}
...
void sf_c11_Modified_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1357996246U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(4290549363U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3429060017U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(202338048U);
}

mxArray* sf_c11_Modified_get_post_codegen_info(void);
mxArray *sf_c11_Modified_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c11_Modified_get_post_codegen_info();
...
mxArray *sf_c11_Modified_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c11_Modified_jit_fallback_info(void)
{
...
mxArray *sf_c11_Modified_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c11_Modified(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[10],T\"derv_oorp3\",},{M[8],M[0],T\"is_active_c11_Modified\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c11_Modified_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc11_ModifiedInstanceStruct *) chartInfo->chartInstance;
...
{
  return "SHAaTKWiIpskEck2dizzcB";
}

static void sf_opaque_initialize_c11_Modified(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc11_ModifiedInstanceStruct*) chartInstanceVar
    )->S,0);
  initialize_params_c11_Modified((SFc11_ModifiedInstanceStruct*)
    chartInstanceVar);
  initialize_c11_Modified((SFc11_ModifiedInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c11_Modified(void *chartInstanceVar)
{
  enable_c11_Modified((SFc11_ModifiedInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c11_Modified(void *chartInstanceVar)
{
  disable_c11_Modified((SFc11_ModifiedInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c11_Modified(void *chartInstanceVar)
{
  sf_gateway_c11_Modified((SFc11_ModifiedInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c11_Modified(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c11_Modified((SFc11_ModifiedInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c11_Modified(SimStruct* S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c11_Modified((SFc11_ModifiedInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c11_Modified(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc11_ModifiedInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c11_Modified((SFc11_ModifiedInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc11_Modified((SFc11_ModifiedInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c11_Modified(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c11_Modified(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(3138933505U));
  ssSetChecksum1(S,(3720237803U));
  ssSetChecksum2(S,(1449829804U));
  ssSetChecksum3(S,(3322517263U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c11_Modified(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c11_Modified(SimStruct *S)
{
  SFc11_ModifiedInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc11_ModifiedInstanceStruct *)utMalloc(sizeof
    (SFc11_ModifiedInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc11_ModifiedInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c11_Modified;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c11_Modified;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c11_Modified;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c11_Modified;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c11_Modified;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c11_Modified;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c11_Modified;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c11_Modified;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c11_Modified;
  chartInstance->chartInfo.mdlStart = mdlStart_c11_Modified;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c11_Modified;
...
void c11_Modified_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c11_Modified(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c11_Modified(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c11_Modified(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c11_Modified_method_dispatcher.\n"
