...
static void initialize_c28_Modified(SFc28_ModifiedInstanceStruct *chartInstance);
static void initialize_params_c28_Modified(SFc28_ModifiedInstanceStruct
  *chartInstance);
static void enable_c28_Modified(SFc28_ModifiedInstanceStruct *chartInstance);
static void disable_c28_Modified(SFc28_ModifiedInstanceStruct *chartInstance);
static void c28_update_debugger_state_c28_Modified(SFc28_ModifiedInstanceStruct *
  chartInstance);
static const mxArray *get_sim_state_c28_Modified(SFc28_ModifiedInstanceStruct
  *chartInstance);
static void set_sim_state_c28_Modified(SFc28_ModifiedInstanceStruct
  *chartInstance, const mxArray *c28_st);
static void finalize_c28_Modified(SFc28_ModifiedInstanceStruct *chartInstance);
static void sf_gateway_c28_Modified(SFc28_ModifiedInstanceStruct *chartInstance);
static void mdl_start_c28_Modified(SFc28_ModifiedInstanceStruct *chartInstance);
static void c28_chartstep_c28_Modified(SFc28_ModifiedInstanceStruct
  *chartInstance);
static void initSimStructsc28_Modified(SFc28_ModifiedInstanceStruct
  *chartInstance);
...
static const mxArray *c28_sf_marshallOut(void *chartInstanceVoid, void
  *c28_inData);
static c28_whl_vec4 c28_emlrt_marshallIn(SFc28_ModifiedInstanceStruct
  *chartInstance, const mxArray *c28_b_delta_w4, const char_T *c28_identifier);
static c28_whl_vec4 c28_b_emlrt_marshallIn(SFc28_ModifiedInstanceStruct
  *chartInstance, const mxArray *c28_u, const emlrtMsgIdentifier *c28_parentId);
static real_T c28_c_emlrt_marshallIn(SFc28_ModifiedInstanceStruct *chartInstance,
...
static const mxArray *c28_b_sf_marshallOut(void *chartInstanceVoid, void
  *c28_inData);
static void c28_d_emlrt_marshallIn(SFc28_ModifiedInstanceStruct *chartInstance,
  const mxArray *c28_u, const emlrtMsgIdentifier *c28_parentId,
  c28_struct_iBlsPBO3AGnt69vDoTx5zD *c28_y);
static void c28_e_emlrt_marshallIn(SFc28_ModifiedInstanceStruct *chartInstance,
  const mxArray *c28_u, const emlrtMsgIdentifier *c28_parentId,
  c28_struct_Nst2vGTExxHsg85EUOj9EH *c28_y);
static c28_struct_HhckT6rntEraqECYVIDvCC c28_f_emlrt_marshallIn
  (SFc28_ModifiedInstanceStruct *chartInstance, const mxArray *c28_u, const
   emlrtMsgIdentifier *c28_parentId);
static void c28_g_emlrt_marshallIn(SFc28_ModifiedInstanceStruct *chartInstance,
  const mxArray *c28_u, const emlrtMsgIdentifier *c28_parentId,
  c28_struct_ZCmOWPuqBDw16FSOVVD00 *c28_y);
static void c28_h_emlrt_marshallIn(SFc28_ModifiedInstanceStruct *chartInstance,
  const mxArray *c28_u, const emlrtMsgIdentifier *c28_parentId, real_T c28_y[4]);
static void c28_i_emlrt_marshallIn(SFc28_ModifiedInstanceStruct *chartInstance,
  const mxArray *c28_u, const emlrtMsgIdentifier *c28_parentId,
  c28_struct_ZKAzdrl7umDGJoC14aoVKC *c28_y);
static void c28_j_emlrt_marshallIn(SFc28_ModifiedInstanceStruct *chartInstance,
...
static void c28_eml_switch_helper(SFc28_ModifiedInstanceStruct *chartInstance);
static void c28_check_forloop_overflow_error(SFc28_ModifiedInstanceStruct
  *chartInstance, boolean_T c28_overflow);
static const mxArray *c28_e_sf_marshallOut(void *chartInstanceVoid, void
  *c28_inData);
static int32_T c28_m_emlrt_marshallIn(SFc28_ModifiedInstanceStruct
  *chartInstance, const mxArray *c28_u, const emlrtMsgIdentifier *c28_parentId);
...
static uint8_T c28_n_emlrt_marshallIn(SFc28_ModifiedInstanceStruct
  *chartInstance, const mxArray *c28_b_is_active_c28_Modified, const char_T
  *c28_identifier);
static uint8_T c28_o_emlrt_marshallIn(SFc28_ModifiedInstanceStruct
  *chartInstance, const mxArray *c28_u, const emlrtMsgIdentifier *c28_parentId);
static void init_dsm_address_info(SFc28_ModifiedInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc28_ModifiedInstanceStruct *chartInstance);
...
static void initialize_c28_Modified(SFc28_ModifiedInstanceStruct *chartInstance)
{
  ...
  chartInstance->c28_is_active_c28_Modified = 0U;
}
  ...
  *chartInstance)
{
  ...
  c28_hoistedGlobal = chartInstance->c28_is_active_c28_Modified;
  ...
  *chartInstance, const mxArray *c28_st)
{
  ...
  *(real_T *)&((char_T *)chartInstance->c28_delta_w4)[24] = c28_r3.rr;
  chartInstance->c28_is_active_c28_Modified = c28_n_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c28_u, 3)),
     "is_active_c28_Modified");
  sf_mex_destroy(&c28_u);
  c28_update_debugger_state_c28_Modified(chartInstance);
...
static void sf_gateway_c28_Modified(SFc28_ModifiedInstanceStruct *chartInstance)
{
  ...
  chartInstance->c28_sfEvent = CALL_EVENT;
  c28_chartstep_c28_Modified(chartInstance);
  ...
  *c28_inData)
{
  ...
  real_T c28_e_u;
  const mxArray *c28_e_y = NULL;
  SFc28_ModifiedInstanceStruct *chartInstance;
  chartInstance = (SFc28_ModifiedInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c28_Modified_get_eml_resolved_functions_info(void)
{
  ...
  *c28_identifier)
{
  ...
  c28_y = c28_o_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c28_b_is_active_c28_Modified), &c28_thisId);
  sf_mex_destroy(&c28_b_is_active_c28_Modified);
  return c28_y;
}
...
void sf_c28_Modified_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c28_Modified_get_post_codegen_info(void);
mxArray *sf_c28_Modified_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c28_Modified_get_post_codegen_info();
...
mxArray *sf_c28_Modified_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c28_Modified_jit_fallback_info(void)
{
...
mxArray *sf_c28_Modified_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c28_Modified(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[8],T\"T_s4\",},{M[1],M[5],T\"T_us4\",},{M[1],M[20],T\"delta_w4\",},{M[8],M[0],T\"is_active_c28_Modified\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c28_Modified_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc28_ModifiedInstanceStruct *) chartInfo->chartInstance;
...
static void sf_opaque_initialize_c28_Modified(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc28_ModifiedInstanceStruct*) chartInstanceVar
    )->S,0);
  initialize_params_c28_Modified((SFc28_ModifiedInstanceStruct*)
    chartInstanceVar);
  initialize_c28_Modified((SFc28_ModifiedInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c28_Modified(void *chartInstanceVar)
{
  enable_c28_Modified((SFc28_ModifiedInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c28_Modified(void *chartInstanceVar)
{
  disable_c28_Modified((SFc28_ModifiedInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c28_Modified(void *chartInstanceVar)
{
  sf_gateway_c28_Modified((SFc28_ModifiedInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c28_Modified(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c28_Modified((SFc28_ModifiedInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c28_Modified(SimStruct* S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c28_Modified((SFc28_ModifiedInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c28_Modified(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc28_ModifiedInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c28_Modified((SFc28_ModifiedInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc28_Modified((SFc28_ModifiedInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c28_Modified(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c28_Modified(SimStruct *S)
{
...
static void mdlRTW_c28_Modified(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c28_Modified(SimStruct *S)
{
  SFc28_ModifiedInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc28_ModifiedInstanceStruct *)utMalloc(sizeof
    (SFc28_ModifiedInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc28_ModifiedInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c28_Modified;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c28_Modified;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c28_Modified;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c28_Modified;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c28_Modified;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c28_Modified;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c28_Modified;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c28_Modified;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c28_Modified;
  chartInstance->chartInfo.mdlStart = mdlStart_c28_Modified;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c28_Modified;
...
void c28_Modified_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c28_Modified(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c28_Modified(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c28_Modified(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c28_Modified_method_dispatcher.\n"
