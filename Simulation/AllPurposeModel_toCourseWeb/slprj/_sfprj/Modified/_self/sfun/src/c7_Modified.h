#ifndef __c7_Modified_h__
#define __c7_Modified_h__
...
#ifndef typedef_SFc7_ModifiedInstanceStruct
#define typedef_SFc7_ModifiedInstanceStruct
...
typedef struct {
  ...
  uint8_T c7_is_active_c7_Modified;
...
#endif                                 /*typedef_SFc7_ModifiedInstanceStruct*/
...
extern const mxArray *sf_c7_Modified_get_eml_resolved_functions_info(void);

/* Function Definitions */
extern void sf_c7_Modified_get_check_sum(mxArray *plhs[]);
extern void c7_Modified_method_dispatcher(SimStruct *S, int_T method, void *data);
