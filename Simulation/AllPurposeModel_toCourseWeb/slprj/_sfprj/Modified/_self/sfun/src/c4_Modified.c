...
static void initialize_c4_Modified(SFc4_ModifiedInstanceStruct *chartInstance);
static void initialize_params_c4_Modified(SFc4_ModifiedInstanceStruct
  *chartInstance);
static void enable_c4_Modified(SFc4_ModifiedInstanceStruct *chartInstance);
static void disable_c4_Modified(SFc4_ModifiedInstanceStruct *chartInstance);
static void c4_update_debugger_state_c4_Modified(SFc4_ModifiedInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c4_Modified(SFc4_ModifiedInstanceStruct
  *chartInstance);
static void set_sim_state_c4_Modified(SFc4_ModifiedInstanceStruct *chartInstance,
  const mxArray *c4_st);
static void finalize_c4_Modified(SFc4_ModifiedInstanceStruct *chartInstance);
static void sf_gateway_c4_Modified(SFc4_ModifiedInstanceStruct *chartInstance);
static void mdl_start_c4_Modified(SFc4_ModifiedInstanceStruct *chartInstance);
static void c4_chartstep_c4_Modified(SFc4_ModifiedInstanceStruct *chartInstance);
static void initSimStructsc4_Modified(SFc4_ModifiedInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c4_machineNumber, uint32_T
  c4_chartNumber, uint32_T c4_instanceNumber);
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData);
static c4_whl_vec4 c4_emlrt_marshallIn(SFc4_ModifiedInstanceStruct
  *chartInstance, const mxArray *c4_b_F_xywSS4, const char_T *c4_identifier);
static c4_whl_vec4 c4_b_emlrt_marshallIn(SFc4_ModifiedInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static real_T c4_c_emlrt_marshallIn(SFc4_ModifiedInstanceStruct *chartInstance,
  const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static const mxArray *c4_b_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static void c4_d_emlrt_marshallIn(SFc4_ModifiedInstanceStruct *chartInstance,
  const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId,
  c4_struct_iBlsPBO3AGnt69vDoTx5zD *c4_y);
static void c4_e_emlrt_marshallIn(SFc4_ModifiedInstanceStruct *chartInstance,
  const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId,
  c4_struct_Nst2vGTExxHsg85EUOj9EH *c4_y);
static c4_struct_HhckT6rntEraqECYVIDvCC c4_f_emlrt_marshallIn
  (SFc4_ModifiedInstanceStruct *chartInstance, const mxArray *c4_u, const
   emlrtMsgIdentifier *c4_parentId);
static void c4_g_emlrt_marshallIn(SFc4_ModifiedInstanceStruct *chartInstance,
  const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId,
  c4_struct_ZCmOWPuqBDw16FSOVVD00 *c4_y);
static void c4_h_emlrt_marshallIn(SFc4_ModifiedInstanceStruct *chartInstance,
  const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId, real_T c4_y[4]);
static void c4_i_emlrt_marshallIn(SFc4_ModifiedInstanceStruct *chartInstance,
  const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId,
  c4_struct_ZKAzdrl7umDGJoC14aoVKC *c4_y);
static void c4_j_emlrt_marshallIn(SFc4_ModifiedInstanceStruct *chartInstance,
...
static void c4_eml_scalar_eg(SFc4_ModifiedInstanceStruct *chartInstance);
static const mxArray *c4_d_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static int32_T c4_m_emlrt_marshallIn(SFc4_ModifiedInstanceStruct *chartInstance,
  const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static const mxArray *c4_s_xy4_bus_io(void *chartInstanceVoid, void *c4_pData);
static uint8_T c4_n_emlrt_marshallIn(SFc4_ModifiedInstanceStruct *chartInstance,
  const mxArray *c4_b_is_active_c4_Modified, const char_T *c4_identifier);
static uint8_T c4_o_emlrt_marshallIn(SFc4_ModifiedInstanceStruct *chartInstance,
  const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void init_dsm_address_info(SFc4_ModifiedInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc4_ModifiedInstanceStruct *chartInstance);
...
static void initialize_c4_Modified(SFc4_ModifiedInstanceStruct *chartInstance)
{
  ...
  chartInstance->c4_is_active_c4_Modified = 0U;
}
  ...
  *chartInstance)
{
  ...
  c4_hoistedGlobal = chartInstance->c4_is_active_c4_Modified;
  ...
  const mxArray *c4_st)
{
  ...
  *(real_T *)&((char_T *)chartInstance->c4_F_xywSS4)[24] = c4_r1.rr;
  chartInstance->c4_is_active_c4_Modified = c4_n_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c4_u, 1)), "is_active_c4_Modified");
  sf_mex_destroy(&c4_u);
  c4_update_debugger_state_c4_Modified(chartInstance);
...
static void sf_gateway_c4_Modified(SFc4_ModifiedInstanceStruct *chartInstance)
{
  ...
  chartInstance->c4_sfEvent = CALL_EVENT;
  c4_chartstep_c4_Modified(chartInstance);
...
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData)
{
  ...
  real_T c4_e_u;
  const mxArray *c4_e_y = NULL;
  SFc4_ModifiedInstanceStruct *chartInstance;
  chartInstance = (SFc4_ModifiedInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c4_Modified_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c4_b_is_active_c4_Modified, const char_T *c4_identifier)
{
  ...
  c4_y = c4_o_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c4_b_is_active_c4_Modified), &c4_thisId);
  sf_mex_destroy(&c4_b_is_active_c4_Modified);
  return c4_y;
}
...
void sf_c4_Modified_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c4_Modified_get_post_codegen_info(void);
mxArray *sf_c4_Modified_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c4_Modified_get_post_codegen_info();
...
mxArray *sf_c4_Modified_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c4_Modified_jit_fallback_info(void)
{
...
mxArray *sf_c4_Modified_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c4_Modified(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[47],T\"F_xywSS4\",},{M[8],M[0],T\"is_active_c4_Modified\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c4_Modified_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc4_ModifiedInstanceStruct *) chartInfo->chartInstance;
...
static void sf_opaque_initialize_c4_Modified(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc4_ModifiedInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c4_Modified((SFc4_ModifiedInstanceStruct*) chartInstanceVar);
  initialize_c4_Modified((SFc4_ModifiedInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c4_Modified(void *chartInstanceVar)
{
  enable_c4_Modified((SFc4_ModifiedInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c4_Modified(void *chartInstanceVar)
{
  disable_c4_Modified((SFc4_ModifiedInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c4_Modified(void *chartInstanceVar)
{
  sf_gateway_c4_Modified((SFc4_ModifiedInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c4_Modified(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c4_Modified((SFc4_ModifiedInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c4_Modified(SimStruct* S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c4_Modified((SFc4_ModifiedInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c4_Modified(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc4_ModifiedInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c4_Modified((SFc4_ModifiedInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc4_Modified((SFc4_ModifiedInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c4_Modified(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c4_Modified((SFc4_ModifiedInstanceStruct*)
      (chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c4_Modified(SimStruct *S)
{
...
static void mdlRTW_c4_Modified(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c4_Modified(SimStruct *S)
{
  SFc4_ModifiedInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc4_ModifiedInstanceStruct *)utMalloc(sizeof
    (SFc4_ModifiedInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc4_ModifiedInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c4_Modified;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c4_Modified;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c4_Modified;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c4_Modified;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c4_Modified;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c4_Modified;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c4_Modified;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c4_Modified;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c4_Modified;
  chartInstance->chartInfo.mdlStart = mdlStart_c4_Modified;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c4_Modified;
...
void c4_Modified_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c4_Modified(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c4_Modified(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c4_Modified(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c4_Modified_method_dispatcher.\n"
