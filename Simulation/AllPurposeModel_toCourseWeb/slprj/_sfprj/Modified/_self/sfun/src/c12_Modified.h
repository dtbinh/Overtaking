#ifndef __c12_Modified_h__
#define __c12_Modified_h__
...
#ifndef typedef_SFc12_ModifiedInstanceStruct
#define typedef_SFc12_ModifiedInstanceStruct
...
typedef struct {
  ...
  uint8_T c12_is_active_c12_Modified;
...
#endif                                 /*typedef_SFc12_ModifiedInstanceStruct*/
...
extern const mxArray *sf_c12_Modified_get_eml_resolved_functions_info(void);

/* Function Definitions */
extern void sf_c12_Modified_get_check_sum(mxArray *plhs[]);
extern void c12_Modified_method_dispatcher(SimStruct *S, int_T method, void
  *data);
